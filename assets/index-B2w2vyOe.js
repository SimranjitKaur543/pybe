...
<g class="tara pose-idle" data-mood="neutral">
  ...
  <!-- near side limbs -->
  ${xe(17,"leg-near")}
  ${be(48,"arm-near",Ie(40,f+104)+Ge(40,f+96))}
...
<g class="mithu">
  ...
  <g class="mithu-feet">
    ...
    L ${i+t*a/2} ${e+o} L ${i-t*a/2} ${e+o} Z" />`}function He(){return`
<defs>
...
</defs>`}const M={floorY:420,taraX:60,wallX:-1090,doorX:390};function Ue(){const{floorY:s}=M;return`
<g class="room">
  <!-- back wall and floor -->
...
</g>`}const A={x0:560,x1:3180,floorY:M.floorY,centreX:1840,askX:1760};function Be(s,e){return`
<g class="fountain">
...
</g>`}function De(){const{x0:s,x1:e,floorY:t,centreX:o}=A,a=-760;return`
<g class="courtyard">
...
</g>`}const _={x0:-1560,x1:3520,roofY:-1320,baseY:1010};function Ke(){return`
<g class="kingdom">
  ...
  <path class="kd-hills far" d="M -6000 980 Q -3000 600 -600 940 Q 1800 1240 4400 860 Q 7400 520 10000 960
    L 10000 3400 L -6000 3400 Z" />
</g>`}function Je(){const{x0:s,x1:e,roofY:t,baseY:o}=_;return`
<g class="shell">
...
</g>`}function es(){const s={x0:-1200,x1:540,y0:-640,y1:M.floorY+120},e={x0:A.x0-20,x1:A.x1+20,y0:-800,y1:A.floorY+200},t={x0:_.x0-80,x1:_.x1+80,y0:_.roofY-160,y1:_.baseY+90};return`
<g class="layer-glows">
  <!-- 1 · her room -->
  <g class="lg lg-local">
...
${ye(3,14,{x:700,y:200,w:1800,h:800})}`}function os(){return`<clipPath id="heroClip">
