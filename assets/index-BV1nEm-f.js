...
<g class="mithu">
  ...
  </g>`}function K(e,s,t,r){const a=t/2,i=e+a;return`M ${e} ${s+r}
          L ${e} ${s+a*.72}
          Q ${e} ${s} ${i} ${s-a*.28}
          Q ${e+t} ${s} ${e+t} ${s+a*.72}
          L ${e+t} ${s+r} Z`}function is(e,s,t,r,a="arch"){return`<path class="${a}" d="${K(e,s,t,r)}" />`}function U(e,s,t,r,a=0){return`<path class="lit-window" style="animation-delay:${a}s" d="${K(e,s,t,r)}" />`}function G(e,s,t,r,a,i,l="arch"){const n=l==="lit"?U:is;return Array.from({length:t},(h,m)=>l==="lit"?n(e+m*(r+i),s,r,a,m*.83%5):n(e+m*(r+i),s,r,a)).join("")}function V(e,s,t,r=30){const a=r/2;return`<g class="stone">
...
<g class="room">
  ...
  <!-- wall niches -->
  <g class="room-niche">
    ${is(-1020,40,130,300,"niche")}
    ${is(-840,40,130,300,"niche")}
  </g>
...
</g>`}function ss(e,s,t,r=0){return`
...
<g class="courtyard">
  ...
  <g class="balconies">
    ${[900,1500,2100,2700].map((i,l)=>`
      <g class="balcony">
        ...
        <path class="balcony-arch" d="${K(i-96,a+60,192,178)}" />
  ...
  <g class="court-arcade">
    ${[760,1180,2500,2920].map(i=>`
      <path class="court-niche" d="${K(i-110,t-430,220,430)}" />`).join("")}
    ${V(970,t-470,t,46)}
    ${V(2710,t-470,t,46)}
  </g>
...
<g class="trails">
  ...
  </g>`}function es(e,s,t,r){return`<g class="flagpole-g">
