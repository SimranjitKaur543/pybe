...
<g class="mithu">
...
</g>`}function K(s,e,t,o,a="stone"){const i=t/2;return`<g class="${a}">
    <path d="M ${s-i} ${e}
  ...
  </g>`}function ie(s,e,t,o){const a=t/2,i=s+a;return`M ${s} ${e+o}
          L ${s} ${e+a*.72}
          Q ${s} ${e} ${i} ${e-a*.28}
          Q ${s+t} ${e} ${s+t} ${e+a*.72}
          L ${s+t} ${e+o} Z`}function we(s,e,t,o,a="arch"){return`<path class="${a}" d="${ie(s,e,t,o)}" />`}function V(s,e,t,o,a=0){return`<path class="lit-window" style="animation-delay:${a}s" d="${ie(s,e,t,o)}" />`}function B(s,e,t,o,a,i,l="arch"){const c=l==="lit"?V:we;return Array.from({length:t},(h,m)=>l==="lit"?c(s+m*(o+i),e,o,a,m*.83%5):c(s+m*(o+i),e,o,a)).join("")}function oe(s,e,t,o=30){const a=o/2;return`<g class="stone">
...
</defs>`}const q={floorY:420,taraX:60,wallX:-1090,doorX:390};function He(){const{floorY:s}=q;return`
<g class="room">
  <!-- back wall and floor -->
...
</g>`}const T={x0:560,x1:3180,floorY:q.floorY,centreX:1840,askX:1760};function Ue(s,e){return`
<g class="fountain">
...
</g>`}function Be(){const{x0:s,x1:e,floorY:t,centreX:o}=T,a=-760;return`
<g class="courtyard">
  ...
  <g class="balconies">
    ${[900,1500,2100,2700].map((i,l)=>`
      <g class="balcony">
        ...
        <path class="balcony-arch" d="${ie(i-96,a+60,192,178)}" />
  ...
  <g class="court-arcade">
    ${[760,1180,2500,2920].map(i=>`
      <path class="court-niche" d="${ie(i-110,t-430,220,430)}" />`).join("")}
    ${oe(970,t-470,t,46)}
    ${oe(2710,t-470,t,46)}
  </g>
...
</g>`}const X={x0:-1560,x1:3520,roofY:-1320,baseY:1010};function Ke(){return`
<g class="kingdom">
  ...
  <path class="kd-hills far" d="M -6000 980 Q -3000 600 -600 940 Q 1800 1240 4400 860 Q 7400 520 10000 960
    L 10000 3400 L -6000 3400 Z" />
</g>`}function Ve(){const{x0:s,x1:e,roofY:t,baseY:o}=X;return`
<g class="shell">
...
</g>`}function Je(){const s={x0:-1200,x1:540,y0:-640,y1:q.floorY+120},e={x0:T.x0-20,x1:T.x1+20,y0:-800,y1:T.floorY+200},t={x0:X.x0-80,x1:X.x1+80,y0:X.roofY-160,y1:X.baseY+90};return`
<g class="layer-glows">
  <!-- 1 · her room -->
  <g class="lg lg-local">
...
</g>`}const n={x:1600,y:300,w:380,h:520,scale:.225},C=980,be=(()=>{let s=12345;const e=()=>(s=(s*9301+49297)%233280)/233280;return Array.from({length:44},()=>({x:-1400+e()*5e3,y:-1500+e()*1900,r:1.6+e()*3.4,d:(e()*6).toFixed(2),layer:e()<.4?"far":"near"}))})();function _(s,e,t,o,a){return`<g class="cloud" style="animation-delay:${o}s; animation-duration:${a}s"
...
<g class="sky-group">
  ...
  <g class="clouds">
    ${_(-900,-1180,1.1,0,96)}
    ${_(-1700,-760,.8,16,122)}
    ${_(-500,-420,1.35,40,148)}
    ${_(-2100,-1420,.9,62,134)}
  </g>
</g>
...
<g class="palace">
  ...
  ${D(2220,700,74,58)}
  ${B(906,800,2,56,150,44,"lit")}
  ${B(2146,800,2,56,150,44,"lit")}
  ...
  ${B(1254,700,2,58,160,52,"lit")}
  ${B(1830,700,2,58,160,52,"lit")}
  ${V(1148,560,48,120,2.1)}
  ${V(1996,560,48,120,.8)}
  ${V(1560,180,74,130,1.6)}
...
<nav class="journey" aria-label="Story progress">
  ...
  <ol class="journey-steps">
    ...
    <div class="stage">
      ...
      <div class="ui">
        <svg class="title-svg" viewBox="0 0 ${I.width} ${I.height}"
    ...
    </div>`;const e=s.querySelector(".world"),t=new Ze(e,I),o=s.querySelector(".tara-slot"),a=me(Ie());o.appendChild(a);const i=new Qe(a,{x:60,y:420,scale:1,facing:"left"}),l=me(ke()+Se("laddoo"),"spark-slot");o.appendChild(l);const c=new Me(l);c.at(520,-300);const h=me(ke()+Se("chameli"),"spark-slot hers");o.appendChild(h);const m=new Me(h);m.at(0,0).setScale(.06);const u=new Ne(s.querySelector(".code-air")),p=new Ss(s.querySelector(".journey"));p.at("local");const L={root:s,camera:t,tara:i,spark:c,hers:m,code:u,journey:p,ui:s.querySelector(".ui")},x=()=>{Oe(),s.querySelector(".hero-window").classList.remove("is-open","is-passed"),s.querySelector(".portal").classList.remove("is-inside"),l.classList.remove("is-live","is-word","is-dimmed"),h.classList.remove("is-live","is-word","is-bouncing","is-straining","is-fading"),m.at(0,0).setScale(.06),s.querySelector(".room").classList.remove("wall-felt"),s.querySelector(".room-door").classList.remove("is-noticed"),s.querySelector(".tara").classList.remove("mithu-alert"),s.querySelector(".wall-ripple").classList.remove("is-hit"),s.querySelector(".room-door").classList.remove("is-open"),s.querySelector(".portal").classList.remove("show-shell"),s.querySelector(".layer-glows").classList.remove("is-live"),s.querySelectorAll(".lg").forEach(v=>v.classList.remove("is-lit")),s.querySelectorAll(".mlabel").forEach(v=>v.classList.remove("is-named")),s.querySelector(".ask-prompt").classList.remove("is-offered","is-taken"),s.querySelector(".ask-speech").classList.remove("is-spoken"),s.querySelector(".q-motes").classList.remove("is-asking"),s.querySelector(".courtyard").classList.remove("is-hushed"),h.classList.remove("is-homebound","is-beckoning","is-inner","is-shadowing","is-touched"),l.classList.remove("is-outer","is-answering","is-shadowed","is-touched"),m.setText("chameli"),c.setText("laddoo"),s.querySelector(".reach").classList.remove("show-global","show-nonlocal","show-shadow"),s.querySelectorAll(".lg").forEach(v=>v.classList.remove("is-probing","is-empty","is-found")),s.querySelectorAll(".mlabel").forEach(v=>v.classList.remove("is-inline")),s.querySelector(".layer-glows").classList.remove("is-searching"),s.querySelector(".tara").classList.remove("has-lantern","has-megaphone","mithu-away"),h.classList.remove("is-hollow","is-claimed","is-hollow-pulse","is-clearing"),s.querySelector(".trails").classList.remove("show-out","show-local","show-blocked","is-barred"),s.querySelector(".error-spell").classList.remove("is-cast"),s.querySelector(".perch-stand").classList.remove("is-up"),s.querySelector(".shadow-tag .mlabel").classList.remove("is-named"),s.querySelector(".stage").classList.remove("is-darkened"),u.clear({duration:0}),u.undock(),s.querySelector(".tara").classList.remove("looks-out","mithu-nods"),s.querySelector(".portal").classList.remove("is-warming"),s.querySelectorAll(".is-waking").forEach(v=>v.classList.remove("is-waking")),s.querySelectorAll(".is-fading").forEach(v=>v.classList.remove("is-fading")),h.classList.remove("is-settled","is-rising","is-star"),l.classList.remove("is-settled"),s.querySelector(".layer-glows").classList.remove("is-soft"),s.querySelector(".replay").classList.remove("is-offered"),s.querySelector(".interact").innerHTML="",p.reset(),p.at("local"),Ee(),s.querySelector(".stage").classList.remove("is-paused");const f=s.querySelector(".pausebtn");f.classList.remove("is-paused"),f.setAttribute("aria-pressed","false"),f.setAttribute("aria-label","Pause the story"),L.ui.classList.remove("is-ending"),delete L.ui.dataset.line,L.ui.classList.remove("show-title","show-sub","show-line"),i.at(60,420),i.facing="left",i.apply(),c.x=520,c.y=-300,c.apply(),t.unfollow(),vs(L)},b=s.querySelector(".pausebtn"),M=s.querySelector(".stage"),y=f=>{M.classList.toggle("is-paused",f),b.classList.toggle("is-paused",f),b.setAttribute("aria-pressed",String(f)),b.setAttribute("aria-label",f?"Resume the story":"Pause the story")};return b.addEventListener("click",()=>y($e())),addEventListener("keydown",f=>{if(f.code!=="Space"&&f.key!==" ")return;const v=f.target;v instanceof Element&&(v.closest("button")||v.getAttribute("role")==="button"||v.isContentEditable)||(f.preventDefault(),y($e()))}),s.querySelector(".replay").addEventListener("click",x),z?(s.querySelector(".hero-window").classList.add("is-open","is-passed"),s.querySelector(".portal").classList.add("is-inside","show-shell"),s.querySelector(".room-door").classList.add("is-open"),h.classList.add("is-live","is-word","is-homebound"),m.at(-620,-240).setScale(1),l.classList.add("is-live","is-word"),c.at(470,-330),i.at(1760,420),i.express("confused"),s.querySelector(".layer-glows").classList.add("is-live"),s.querySelectorAll(".lg").forEach(f=>f.classList.add("is-lit")),s.querySelectorAll(".mlabel").forEach(f=>f.classList.add("is-named")),m.setText("TARA"),h.classList.add("is-inner"),m.at(-560,-300),c.setText("MITHU"),l.classList.add("is-outer"),c.at(1900,-1180),t.set({x:n.x+980*n.scale,y:n.y+-940*n.scale,zoom:t.zoomToFitWidth(1760)}),u.dock(),u.write(['name = "Mithu"',"","def room():",'    name = "Tara"',"    print(name)"],{stagger:0}),u.note(0,"Global — the palace name"),u.note(3,"assigning makes a NEW local name"),u.note(4,"finds the local one first"),L.ui.dataset.line="names",L.ui.classList.add("show-line")):x(),L}qs(document.getElementById("app"));
