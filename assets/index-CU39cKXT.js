...
<g class="mithu">
  ...
  <g class="mithu-feet">
    ...
    <circle cx="${e}" cy="${s-o-34}" r="7" />
          ...
          Q ${e} ${s} ${i} ${s-t*.28}
          Q ${e+a} ${s} ${e+a} ${s+t*.72}
          L ${e+a} ${s+o} Z`}function _(e,s,a,o,t="arch"){return`<path class="${t}" d="${X(e,s,a,o)}" />`}function Q(e,s,a,o,t=0){return`<path class="lit-window" style="animation-delay:${t}s" d="${X(e,s,a,o)}" />`}function P(e,s,a,o,t,i,r="arch"){const n=r==="lit"?Q:_;return Array.from({length:a},(h,w)=>r==="lit"?n(e+w*(o+i),s,o,t,w*.83%5):n(e+w*(o+i),s,o,t)).join("")}function G(e,s,a,o=30){const t=o/2;return`<g class="stone">
  ...
  </g>`}function R(e,s,a,o){const t=a/2;return`<g class="stone">
    <rect x="${e-t}" y="${s-7}" width="${a}" height="8" rx="4" />
    <rect x="${e-t+5}" y="${s-o}" width="6" height="${o-7}" />
    <rect x="${e+t-11}" y="${s-o}" width="6" height="${o-7}" />
  </g>${F(e,s-o,a*.9,o*.7)}`}function Y(e=0,s=18,a={x:0,y:0,w:1600,h:900}){let o=e*9301+49297;const t=()=>(o=(o*9301+49297)%233280)/233280;return`<g class="motes">${Array.from({length:s},()=>{const i=a.x+t()*a.w,r=a.y+t()*a.h,n=2+t()*2.6,h=(t()*9).toFixed(2),w=(7+t()*7).toFixed(2);return`<circle cx="${i}" cy="${r}" r="${n}" style="animation-delay:${h}s; animation-duration:${w}s" />`}).join("")}</g>`}function as(e,s,a,o,t=2.6){const i=e+a/2;return`<path class="light-shaft" d="M ${e} ${s} L ${e+a} ${s}
    L ${i+a*t/2} ${s+o} L ${i-a*t/2} ${s+o} Z" />`}function ys(){return`
<defs>
...
</defs>`}const x={floorY:420,taraX:60,wallX:-1090,doorX:390};function fs(){const{floorY:e}=x;return`
<g class="room">
  <!-- back wall and floor -->
...
</g>`}const L={x0:560,x1:3180,floorY:x.floorY,centreX:1840,askX:1760};function xs(e,s){return`
<g class="fountain">
...
</g>`}function Ls(){const{x0:e,x1:s,floorY:a,centreX:o}=L,t=-760;return`
<g class="courtyard">
...
<g class="kingdom">
  ...
  <path class="kd-hills far" d="M -6000 980 Q -3000 600 -600 940 Q 1800 1240 4400 860 Q 7400 520 10000 960
    L 10000 3400 L -6000 3400 Z" />
</g>`}function qs(){const{x0:e,x1:s,roofY:a,baseY:o}=E;return`
<g class="shell">
...
</g>`}function Ts(){const e={x0:-1200,x1:540,y0:-640,y1:x.floorY+120},s={x0:L.x0-20,x1:L.x1+20,y0:-800,y1:L.floorY+200},a={x0:E.x0-80,x1:E.x1+80,y0:E.roofY-160,y1:E.baseY+90};return`
<g class="layer-glows">
  <!-- 1 · her room -->
  <g class="lg lg-local">
...
<g class="trails">
...
</g>`}const c={x:1600,y:300,w:380,h:520,scale:.225},S=980,ts=(()=>{let e=12345;const s=()=>(e=(e*9301+49297)%233280)/233280;return Array.from({length:44},()=>({x:-1400+s()*5e3,y:-1500+s()*1900,r:1.6+s()*3.4,d:(s()*6).toFixed(2),layer:s()<.4?"far":"near"}))})();function Z(e,s,a,o,t){return`<g class="cloud" style="animation-delay:${o}s; animation-duration:${t}s"
  ...
  </g>`}function U(e,s,a,o){return`<g class="flagpole-g">
  ...
  <g class="portal" clip-path="url(#heroClip)">
    <g transform="translate(${c.x} ${c.y}) scale(${c.scale})">
      ...
      <g class="magic-labels">
        ${A("local","Local",-330,-900,"inside one function")}
        ${A("enclosing","Enclosing",1870,-1120,"a function written inside another")}
        ${A("global","Global",980,-1760,"the whole file")}
        ${A("builtin","Built-in",980,-2520,"names Python already knows")}
      </g>
      ${zs()}
      ${Ms()}
      ${As()}
...
</g>`}function ls(e){const s=Math.max(190,e.length*30+84);return`
...
</g>`}function Ps(e=26){let s=777;const a=()=>(s=(s*9301+49297)%233280)/233280;return`<g class="title-motes">${Array.from({length:e},()=>{const o=a()*Math.PI*2,t=300+a()*620;return`<circle r="${2+a()*3.2}"
      style="--fx:${(Math.cos(o)*t).toFixed(1)}px; --fy:${(Math.sin(o)*t*.6).toFixed(1)}px;
             animation-delay:${(a()*1.1).toFixed(2)}s" />`}).join("")}</g>`}const m=(e,s)=>({x:c.x+e*c.scale,y:c.y+s*c.scale}),os={x:26,y:176},z=x.wallX;async function Rs(e){const{camera:s,tara:a,spark:o,hers:t,ui:i,root:r}=e,n=r.querySelector(".room"),h=r.querySelector(".wall-ripple");i.classList.contains("show-title")&&(i.classList.add("title-out"),await l(900),i.classList.remove("show-title","show-sub","title-out")),o.moveTo(470,-330,{duration:1500,easing:g.inOut}),r.querySelector(".spark-slot").classList.add("is-dimmed"),await s.to({...m(a.x-30,150),zoom:s.fitRoom(1569),duration:1400}),a.express("curious"),await l(500),await s.to({...m(a.x+10,70),zoom:s.fitRoom(1067),duration:1400}),await l(400),a.setPose("whisper"),await l(500),t.at(a.x+os.x,a.y-os.y).setScale(.06),t.el.classList.add("is-live"),await l(300),await t.scaleTo(1,{duration:1e3,easing:g.back}),t.el.classList.add("is-word"),await l(400),a.setPose("idle"),a.express("happy"),await b(t.moveTo(a.x+120,a.y-330,{duration:1400,easing:g.out}),s.to({...m(a.x+60,-60),zoom:s.fitRoom(1356),duration:1400})),await l(400),a.express("curious"),s.follow(t,{map:(w,u)=>m(w,u),offsetY:60,lag:.035}),await t.moveTo(-180,-400,{duration:1400,easing:g.inOut}),await t.moveTo(-430,-250,{duration:1400,easing:g.inOut}),await b(a.walkTo(-320,{speed:200}),t.moveTo(-700,-320,{duration:1400,easing:g.inOut})),await t.moveTo(z,-300,{duration:1400,easing:g.in}),h.setAttribute("transform",`translate(${z-20} -300)`),h.classList.remove("is-hit"),h.getBoundingClientRect(),h.classList.add("is-hit"),t.el.classList.add("is-bouncing"),s.shake(9),await t.moveTo(z+250,-350,{duration:700,easing:g.out}),t.el.classList.remove("is-bouncing"),s.unfollow(),await s.to({...m(-520,-190),zoom:s.fitRoom(1455),duration:1200}),a.express("surprised"),await l(500),a.express("curious"),s.follow(t,{map:(w,u)=>m(w,u),offsetY:40,lag:.03}),await t.moveTo(z+30,-270,{duration:1400,easing:g.inOut}),h.classList.remove("is-hit"),h.getBoundingClientRect(),h.setAttribute("transform",`translate(${z-10} -270)`),h.classList.add("is-hit"),t.el.classList.add("is-straining"),s.shake(5),await l(600),t.el.classList.add("is-fading"),await l(900),t.el.classList.remove("is-live","is-word","is-straining","is-fading"),s.unfollow(),await s.to({...m(-560,-60),zoom:s.fitRoom(1379),duration:1400}),a.express("confused"),await l(600),await a.walkTo(-760,{speed:150}),await a.face("left"),a.setPose("touch"),n.classList.add("wall-felt"),await l(1e3),r.querySelector(".tara").classList.add("mithu-alert"),await l(700),a.setPose("idle"),await a.face("right"),a.express("curious"),await s.to({...m(-420,-40),zoom:s.fitRoom(1905),duration:1400}),await l(400),r.querySelector(".room-door").classList.add("is-noticed"),await l(800),i.dataset.line="far",i.classList.add("show-line"),await l(4e3),i.classList.remove("show-line"),n.classList.remove("wall-felt"),r.querySelector(".tara").classList.remove("mithu-alert"),r.querySelector(".room-door").classList.remove("is-noticed"),await l(300)}async function Os(e){const{camera:s,tara:a,hers:o,ui:t,root:i}=e,r=i.querySelector(".room-door"),n=i.querySelector(".ask-prompt"),h=i.querySelector(".ask-anchor"),w=i.querySelector(".ask-speech"),u=i.querySelector(".ask-speech-anchor"),p=i.querySelector(".q-motes");o.at(-620,-240).setScale(1),o.el.classList.add("is-live","is-word","is-homebound"),await l(400),i.querySelector(".tara").classList.add("mithu-alert"),await l(500),a.express("curious"),await a.face("right"),await l(300),r.classList.add("is-open"),await l(500),s.follow(a,{map:(v,y)=>m(v,y),offsetY:-150,lag:.028}),await a.walkTo(x.doorX+40,{speed:210}),await l(400),await a.walkTo(L.x0+300,{speed:200}),s.unfollow(),await s.to({...m(L.centreX-260,-120),zoom:s.fitRoom(3077),duration:2300,easing:g.inOut}),a.express("surprised"),await l(500),await a.face("left"),await l(300),await a.face("right"),a.express("curious"),await l(400),h.setAttribute("transform",`translate(${L.askX} -470)`),await s.to({...m(L.askX,-250),zoom:s.fitRoom(2150),duration:1600,easing:g.inOut}),await a.face("right"),n.classList.add("is-offered"),await new Promise(v=>{const y=setTimeout(()=>n.classList.add("is-urging"),7e3),N=()=>{clearTimeout(y),n.classList.remove("is-urging"),n.removeEventListener("click",N),n.removeEventListener("keydown",V),v()},V=j=>{(j.key==="Enter"||j.key===" ")&&(j.preventDefault(),N())};n.addEventListener("click",N),n.addEventListener("keydown",V)}),n.classList.remove("is-offered"),n.classList.add("is-taken"),await b(a.walkTo(L.askX,{speed:190}),s.to({...m(L.askX+60,-180),zoom:s.fitRoom(2667),duration:1700})),await l(300),await a.face("left"),await l(300),a.setPose("reach"),a.express("curious"),u.setAttribute("transform",`translate(${L.askX+30} -330)`),w.classList.add("is-spoken"),await l(1100),a.setPose("idle"),w.classList.remove("is-spoken"),p.setAttribute("transform",`translate(${L.askX+40} -420)`),p.classList.add("is-asking"),i.querySelector(".courtyard").classList.add("is-hushed"),await l(1100),p.classList.remove("is-asking"),a.express("confused"),i.querySelector(".tara").classList.add("mithu-alert"),await l(700),await a.face("left"),await l(300),await s.to({...m(700,-180),zoom:s.fitRoom(4706),duration:2300,easing:g.inOut}),o.el.classList.add("is-beckoning"),await l(1100),t.dataset.line="born",t.classList.add("show-line"),await l(4800),t.classList.remove("show-line"),await l(400),i.querySelector(".tara").classList.remove("mithu-alert"),i.querySelector(".courtyard").classList.remove("is-hushed"),o.el.classList.remove("is-beckoning")}const Zs=[{id:"local",cls:"lg-local"},{id:"enclosing",cls:"lg-enclosing"},{id:"global",cls:"lg-global"},{id:"builtin",cls:"lg-builtin"}];async function Fs(e){const{camera:s,tara:a,code:o,ui:t,root:i}=e,r=i.querySelector(".layer-glows"),n=i.querySelector(".magic-labels");a.setPose("idle").express("curious"),await s.to({...m(900,-420),zoom:s.zoomToFitWidth(1080),duration:2300,easing:g.inOut}),await l(300),i.querySelector(".portal").classList.add("show-shell"),await s.to({...m(980,-940),zoom:s.zoomToFitWidth(1760),duration:2600,easing:g.inOut}),await l(500),r.classList.add("is-live");for(const h of Zs)i.querySelector(`.${h.cls}`).classList.add("is-lit"),await l(400),n.querySelector(`.mlabel-${h.id}`).classList.add("is-named"),await l(900);await l(500),t.dataset.line="names",t.classList.add("show-line"),await l(3600),t.classList.remove("show-line"),t.dataset.line="legb",t.classList.add("show-line"),await l(4600),t.classList.remove("show-line"),o.dock(),await o.write(['name = "Mithu"'],{stagger:0}),o.note(0,"Global — out in the open palace"),await l(1600)}const Qs=[{cls:"lg-local",found:!1,note:"not in room() — look outward"},{cls:"lg-enclosing",found:!1,note:"not in the enclosing space either"},{cls:"lg-global",found:!0,note:"found it — the palace name"}];async function Ws(e){const{camera:s,tara:a,spark:o,hers:t,code:i,ui:r,root:n}=e,h=n.querySelector(".layer-glows"),w=n.querySelector(".tara");n.querySelectorAll(".mlabel").forEach(u=>u.classList.remove("is-named")),n.querySelectorAll(".lg").forEach(u=>u.classList.remove("is-lit")),o.setText("MITHU").at(1900,-1180).setScale(1),o.el.classList.remove("is-dimmed"),o.el.classList.add("is-live","is-word","is-outer"),await s.to({...m(760,-560),zoom:s.zoomToFitWidth(1180),duration:1700}),a.express("curious"),await l(500),w.classList.add("mithu-alert"),r.dataset.line="wider",r.classList.add("show-line"),await l(3400),r.classList.remove("show-line"),w.classList.remove("mithu-alert"),i.clearNotes(),await i.append(["","def room():","    print(name)"],{stagger:380}),i.focus(3),await l(500),w.classList.add("has-lantern"),await l(500),h.classList.add("is-live","is-searching");for(const u of Qs){const p=n.querySelector(`.${u.cls}`);p.classList.add("is-lit","is-probing"),i.note(3,u.note),u.cls==="lg-enclosing"&&b(a.walkTo(L.centreX-200,{speed:230}),s.to({...m(900,-640),zoom:s.zoomToFitWidth(1420),duration:1800})),u.cls==="lg-global"&&s.to({...m(980,-860),zoom:s.zoomToFitWidth(1780),duration:1900}),await l(1100),u.found?(p.classList.remove("is-probing"),p.classList.add("is-found"),o.el.classList.add("is-answering"),i.mark(3,"is-ok"),a.express("happy"),s.shake(5),await l(1400)):(p.classList.remove("is-probing"),p.classList.add("is-empty"),await l(300))}await l(800),i.unmark("is-ok"),i.note(3,"and print? found in the outermost ring"),n.querySelector(".lg-builtin").classList.add("is-lit","is-found"),n.querySelector(".mlabel-builtin").classList.add("is-named"),await l(1e3),r.dataset.line="builtin",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),n.querySelector(".mlabel-builtin").classList.remove("is-named"),n.querySelectorAll(".lg").forEach(u=>u.classList.remove("is-empty","is-found")),h.classList.remove("is-searching"),o.el.classList.remove("is-answering"),i.unfocus(),i.clearNotes()}const I={x:-560,y:-300};async function Xs(e){const{camera:s,tara:a,spark:o,hers:t,code:i,ui:r,root:n}=e,h=n.querySelector(".tara");await b(a.walkTo(x.taraX-120,{speed:240}),s.to({...m(-120,-240),zoom:s.zoomToFitWidth(760),duration:2200})),h.classList.remove("has-lantern"),await a.face("right"),a.express("curious"),await l(500),a.setPose("whisper"),await l(500),t.setText("MITHU").at(I.x,I.y).setScale(.05),t.el.classList.remove("is-homebound","is-beckoning"),t.el.classList.add("is-live","is-inner"),await t.scaleTo(1,{duration:1e3,easing:g.back}),t.el.classList.add("is-word"),a.setPose("idle"),await i.retype(3,'    name = "Tara"'),i.mark(3,"is-claim"),i.note(3,"assigning MAKES a new local name"),await i.append(["    print(name)"],{stagger:0}),await l(1e3),await s.to({...m(560,-620),zoom:s.zoomToFitWidth(1500),duration:1800}),await l(800),await s.to({...m(-260,-260),zoom:s.zoomToFitWidth(820),duration:1600}),await a.walkTo(I.x+250,{speed:200}),await a.face("left"),a.setPose("reach"),await l(300),t.el.classList.add("is-touched"),s.shake(4),await t.morphTo("TARA",{duration:1100}),t.el.classList.remove("is-touched"),a.setPose("idle"),a.express("surprised"),await l(500),await s.to({...m(620,-640),zoom:s.zoomToFitWidth(1560),duration:1800}),o.el.classList.add("is-answering"),i.note(0,"untouched"),await l(1100),o.el.classList.remove("is-answering"),i.note(0,""),a.express("happy"),h.classList.add("mithu-alert"),await l(800),h.classList.remove("mithu-alert");const w=n.querySelector(".mlabel-local");w.classList.add("is-named","is-inline"),await l(1700),i.unmark("is-claim"),i.focus(3),await l(700),r.dataset.line="readassign",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),i.unfocus(),await s.to({...m(-160,-420),zoom:s.zoomToFitWidth(1120),duration:1800}),await l(400),n.querySelector(".reach").classList.add("show-shadow"),o.el.classList.add("is-shadowed"),t.el.classList.add("is-shadowing"),i.focus(4),i.note(4,"finds the local one; outer is hidden"),await l(1400),r.dataset.line="hides",r.classList.add("show-line"),await l(4200),r.classList.remove("show-line"),await l(500),i.unfocus(),i.clearNotes(),w.classList.remove("is-inline","is-named")}async function Gs(e){const{camera:s,tara:a,spark:o,hers:t,code:i,ui:r,root:n}=e,h=n.querySelector(".tara"),w=n.querySelector(".reach");w.classList.remove("show-shadow"),o.el.classList.remove("is-shadowed"),t.el.classList.remove("is-shadowing"),await l(400),await s.to({...m(400,-620),zoom:s.zoomToFitWidth(1420),duration:1800}),await a.face("right"),a.express("curious"),await l(700),h.classList.add("mithu-alert"),r.dataset.line="speak",r.classList.add("show-line"),await l(3600),r.classList.remove("show-line"),h.classList.remove("mithu-alert"),await s.to({...m(-200,-300),zoom:s.zoomToFitWidth(880),duration:1600}),h.classList.add("has-megaphone"),await l(500),a.setPose("reach"),a.express("happy"),await l(500),await s.to({...m(700,-700),zoom:s.zoomToFitWidth(1620),duration:1700}),await i.retype(3,"    global name"),i.mark(3,"is-claim"),i.note(3,"rebinds the palace name, not a local one"),await i.append(['    name = "Tara"'],{stagger:0}),await l(800),w.classList.add("show-global"),s.shake(6),await l(1100),o.el.classList.add("is-touched"),await o.morphTo("TARA",{duration:1200}),o.el.classList.remove("is-touched"),o.el.classList.add("is-answering"),s.shake(8),await l(1100),a.setPose("idle"),o.el.classList.remove("is-answering"),w.classList.remove("show-global"),h.classList.remove("has-megaphone"),await l(500);const u=n.querySelector(".mlabel-global");u.classList.add("is-named","is-inline"),await l(1700),u.classList.remove("is-inline","is-named"),await s.to({...m(260,-420),zoom:s.zoomToFitWidth(1240),duration:1700}),h.classList.add("mithu-alert"),i.unmark("is-claim"),i.clearNotes(),await i.write(["def palace():",'    name = "Mithu"',"","    def room():","        nonlocal name",'        name = "Tara"'],{stagger:300}),i.focus(4),i.note(4,"reaches the ENCLOSING room only"),w.classList.add("show-nonlocal"),await l(1100),r.dataset.line="nonlocal",r.classList.add("show-line"),await l(4600),r.classList.remove("show-line"),w.classList.remove("show-nonlocal"),h.classList.remove("mithu-alert"),i.unfocus(),i.clearNotes(),a.express("happy"),await l(700)}async function Ns(e){const{camera:s,tara:a,spark:o,hers:t,code:i,ui:r,root:n}=e,h=n.querySelector(".tara"),w=n.querySelector(".trails"),u=n.querySelector(".error-spell");o.setText("MITHU").at(1900,-1180),o.el.classList.add("is-live","is-word","is-outer"),o.el.classList.remove("is-shadowed"),t.el.classList.remove("is-word","is-live","is-inner","is-shadowing","is-hollow"),await s.to({...m(40,-140),zoom:s.fitRoom(1500),duration:2e3}),await a.face("right"),a.express("curious"),await i.write(['name = "Mithu"',"","def room():","    print(name)",'    name = "Tara"'],{stagger:300}),await l(500),w.classList.add("show-out"),o.el.classList.add("is-answering"),await l(1100),w.classList.remove("show-out"),o.el.classList.remove("is-answering"),await l(400),await s.to({...m(-380,-200),zoom:s.fitRoom(1e3),duration:1600}),await a.face("left"),a.setPose("reach"),await l(400),t.setText("name").at(-560,-300).setScale(.1),t.el.classList.add("is-live","is-hollow"),await t.scaleTo(1,{duration:900,easing:g.back}),t.el.classList.add("is-word"),s.shake(4),a.setPose("idle"),await l(700),t.el.classList.add("is-claimed"),i.focus(4),i.note(4,"seen first — so name is local everywhere"),await l(1400),a.setPose("reach"),a.express("curious"),w.classList.add("show-local"),i.focus(3),i.note(3,"runs first — local name still empty"),await l(1e3),t.el.classList.add("is-hollow-pulse"),await l(800),w.classList.remove("show-local"),await s.to({...m(140,-300),zoom:s.fitRoom(1700),duration:1600}),w.classList.add("show-blocked"),await l(500),w.classList.add("is-barred"),s.shake(9),a.setPose("surprise"),a.express("surprised"),h.classList.add("mithu-alert"),await l(800),w.classList.remove("show-blocked","is-barred"),n.querySelector(".stage").classList.add("is-darkened"),u.setAttribute("transform","translate(120 -760)"),u.classList.add("is-cast"),i.mark(3,"is-error"),i.focus(3),s.shake(12),await l(1400),r.dataset.line="claimed",r.classList.add("show-line"),await l(4200),r.classList.remove("show-line"),await l(300),r.dataset.line="lookedthere",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),await l(800),u.classList.remove("is-cast"),n.querySelector(".stage").classList.remove("is-darkened"),h.classList.remove("mithu-alert"),a.setPose("idle"),t.el.classList.remove("is-hollow-pulse"),i.unmark("is-error"),i.unfocus(),i.clearNotes(),await l(500)}const rs={x:620,y:-1180};async function js(e){const{camera:s,tara:a,spark:o,hers:t,code:i,ui:r,root:n}=e,h=n.querySelector(".tara"),w=n.querySelector(".trails"),u=n.querySelector(".perch-stand"),p=n.querySelector(".error-spell");await b(a.walkTo(x.taraX-220,{speed:200}),s.to({...m(-120,-260),zoom:s.fitRoom(1300),duration:1900})),await a.face("right"),a.setPose("sit"),a.express("curious"),u.setAttribute("transform",`translate(${x.taraX+190} ${x.floorY})`),u.classList.add("is-up"),h.classList.add("mithu-away"),await l(500),r.dataset.line="rules",r.classList.add("show-line"),await l(3800),r.classList.remove("show-line"),i.at(rs.x,rs.y),i.undock(),await i.clear({duration:400}),await s.to({...m(520,-760),zoom:s.fitRoom(2100),duration:1800}),t.el.classList.remove("is-word","is-live","is-hollow","is-claimed","is-hollow-pulse","is-inner","is-shadowing","is-clearing"),o.setText("MITHU").at(1900,-1180),o.el.classList.add("is-live","is-word","is-outer"),await i.write(['name = "Mithu"',"","def room():","    print(name)"]),await l(300),i.focus(3),w.classList.add("show-out"),await l(500),o.el.classList.add("is-answering"),await l(700),r.dataset.line="lookout",r.classList.add("show-line"),await l(3900),r.classList.remove("show-line"),w.classList.remove("show-out"),o.el.classList.remove("is-answering"),i.unfocus(),await i.clear(),await i.write(['name = "Mithu"',"","def room():",'    name = "Tara"',"    print(name)"]),await l(300),i.focus(3),t.setText("TARA").at(-560,-300).setScale(.1),t.el.classList.remove("is-hollow","is-claimed"),t.el.classList.add("is-live","is-inner"),await t.scaleTo(1,{duration:900,easing:g.back}),t.el.classList.add("is-word"),await l(400),i.focus(4),w.classList.add("show-local"),t.el.classList.add("is-shadowing"),o.el.classList.add("is-shadowed"),await l(800),r.dataset.line="hides",r.classList.add("show-line"),await l(3800),r.classList.remove("show-line");const v=n.querySelector(".shadow-tag .mlabel");v.classList.add("is-named"),await l(1100),v.classList.remove("is-named"),w.classList.remove("show-local"),o.el.classList.remove("is-shadowed"),t.el.classList.remove("is-shadowing"),i.unfocus(),await i.clear(),await i.write(['name = "Mithu"',"","def room():","    print(name)",'    name = "Tara"']),await l(300),i.focus(4),await l(500),t.setText("name").at(-560,-300).setScale(.1),t.el.classList.remove("is-inner"),t.el.classList.add("is-live","is-hollow"),await t.scaleTo(1,{duration:800,easing:g.back}),t.el.classList.add("is-word","is-claimed"),s.shake(4),await l(700),i.focus(3),w.classList.add("show-blocked"),t.el.classList.add("is-hollow-pulse"),await l(500),w.classList.add("is-barred"),s.shake(8),await l(500),w.classList.remove("show-blocked","is-barred"),p.setAttribute("transform","translate(620 -320)"),n.querySelector(".stage").classList.add("is-darkened"),p.classList.add("is-cast"),i.mark(3,"is-error"),await l(900),r.dataset.line="assigns",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),await l(300),r.dataset.line="novalue",r.classList.add("show-line"),await l(4e3),r.classList.remove("show-line"),p.classList.remove("is-cast"),n.querySelector(".stage").classList.remove("is-darkened"),i.unfocus(),i.unmark("is-error"),await i.clear(),t.el.classList.remove("is-hollow-pulse"),await i.write(["len = 5",'print(len("palace"))'],{stagger:380}),await l(300),i.focus(0),i.note(0,"this hides the built-in len"),n.querySelector(".lg-builtin").classList.add("is-lit"),n.querySelector(".mlabel-builtin").classList.add("is-named"),await l(900),i.focus(1),i.mark(1,"is-error"),i.note(1,"TypeError — 5 is not a function"),s.shake(6),a.express("surprised"),await l(1100),r.dataset.line="shadowbuiltin",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),n.querySelector(".mlabel-builtin").classList.remove("is-named"),n.querySelector(".lg-builtin").classList.remove("is-lit"),i.unfocus(),i.unmark("is-error"),i.clearNotes(),await i.clear(),a.express("curious"),await s.to({...m(-140,-180),zoom:s.fitRoom(1500),duration:1600}),a.setPose("idle");for(let y=0;y<2;y+=1)await a.walkTo(x.taraX-160,{speed:240}),t.setText("TARA").at(-560,-300).setScale(.1),t.el.classList.remove("is-hollow","is-claimed"),t.el.classList.add("is-live","is-inner"),await t.scaleTo(1,{duration:700,easing:g.back}),t.el.classList.add("is-word"),await l(500),await a.walkTo(x.doorX+60,{speed:240}),t.el.classList.add("is-clearing"),await l(400),t.el.classList.remove("is-live","is-word","is-clearing","is-inner"),await l(300);r.dataset.line="freshcall",r.classList.add("show-line"),await l(4e3),r.classList.remove("show-line"),await a.walkTo(x.taraX-160,{speed:220}),await a.face("right"),a.express("happy"),await s.to({...m(980,-940),zoom:s.zoomToFitWidth(1760),duration:2400}),n.querySelector(".layer-glows").classList.add("is-live");for(const y of["local","enclosing","global","builtin"])n.querySelector(`.lg-${y}`).classList.add("is-lit"),await l(300);await l(500),r.dataset.line="begins",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),await l(500)}const W=["local","enclosing","global","builtin"],Hs=[{name:"secret",target:0},{name:"place",target:1},{name:"name",target:2},{name:"print",target:3}],Us=[{line:6,id:"local",note:"Local — this call only"},{line:3,id:"enclosing",note:"Enclosing — the function wrapped around it"},{line:0,id:"global",note:"Global — the top level of the file"},{line:7,id:"builtin",note:"print — Built-in, always there"}];function ds(e){W.forEach(s=>{e.querySelector(`.lg-${s}`).classList.remove("is-lit","is-probing","is-found","is-empty")})}async function Is(e,s,a,o){ds(e),s.setText(a).at(1900,-1180).setScale(1),s.el.classList.remove("is-dimmed","is-answering"),s.el.classList.add("is-live","is-word"),await l(900);for(let t=0;t<=o;t+=1){const i=e.querySelector(`.lg-${W[t]}`);i.classList.add("is-lit","is-probing"),await l(t===o?850:600),i.classList.remove("is-probing"),t===o?(i.classList.add("is-found"),e.querySelector(`.mlabel-${W[t]}`).classList.add("is-named"),s.el.classList.add("is-answering"),await l(1700),e.querySelector(`.mlabel-${W[t]}`).classList.remove("is-named"),s.el.classList.remove("is-answering")):(i.classList.add("is-empty"),await l(260))}await l(400)}async function Bs(e){const{camera:s,tara:a,spark:o,hers:t,code:i,ui:r,root:n}=e,h=n.querySelector(".tara"),w=n.querySelector(".perch-stand");await i.clear(),w.classList.remove("is-up"),h.classList.remove("mithu-away"),n.querySelectorAll(".mlabel").forEach(u=>u.classList.remove("is-named","is-inline")),n.querySelectorAll(".lg").forEach(u=>u.classList.remove("is-lit")),await l(600),a.setPose("idle").express("happy"),await b(a.walkTo(L.centreX+620,{speed:190}),s.to({...m(L.centreX+300,-260),zoom:s.fitRoom(2200),duration:4100})),await a.face("right"),await l(600),n.querySelector(".portal").classList.add("show-shell","is-warming"),await s.to({...m(900,-620),zoom:s.fitRoom(3200),duration:3e3}),t.el.classList.add("is-settled"),o.el.classList.add("is-settled"),h.classList.add("looks-out"),a.express("happy"),await l(900),r.dataset.line="belong",r.classList.add("show-line"),await l(3400),r.classList.remove("show-line"),await s.to({...m(980,-940),zoom:s.zoomToFitWidth(1760),duration:3e3}),n.querySelector(".layer-glows").classList.add("is-live"),await l(700),r.dataset.line="fourplaces",r.classList.add("show-line"),await l(3400),r.classList.remove("show-line");for(const{name:u,target:p}of Hs)await Is(n,o,u,p);ds(n),o.el.classList.remove("is-live","is-word"),await l(800),i.undock(),await i.write(['name = "Mithu"',"","def palace():",'    place = "courtyard"',"","    def room():",'        secret = "laddoo"',"        print(name, place, secret)"],{stagger:300}),await l(900),n.querySelector(".layer-glows").classList.add("is-soft");for(const{line:u,id:p,note:v}of Us)i.focus(u),i.note(u,v),n.querySelector(`.lg-${p}`).classList.add("is-lit"),n.querySelector(`.mlabel-${p}`).classList.add("is-named"),await l(2600),n.querySelector(`.mlabel-${p}`).classList.remove("is-named");i.unfocus(),await l(900),r.dataset.line="legb",r.classList.add("show-line"),await l(4600),r.classList.remove("show-line"),await l(500),r.dataset.line="assignrule",r.classList.add("show-line"),await l(4800),r.classList.remove("show-line"),await l(600),await i.clear(),n.querySelectorAll(".mlabel").forEach(u=>u.classList.add("is-fading")),n.querySelectorAll(".lg").forEach(u=>u.classList.add("is-fading")),await l(1100),n.querySelectorAll(".mlabel").forEach(u=>u.classList.remove("is-named","is-fading")),n.querySelectorAll(".lg").forEach(u=>u.classList.remove("is-lit","is-fading")),n.querySelector(".layer-glows").classList.remove("is-soft"),await s.to({...m(900,-820),zoom:s.zoomToFitWidth(1900),duration:3e3}),await l(600),r.dataset.line="bridge",r.classList.add("show-line"),await l(4200),r.classList.remove("show-line"),await l(400),r.classList.add("is-ending"),r.classList.add("show-title"),await l(4200),r.classList.add("show-sub"),await l(1600),n.querySelector(".replay").classList.add("is-offered")}async function _s(e){const{camera:s,tara:a,spark:o,ui:t}=e;s.set({x:300,y:-1080,zoom:s.zoomToFitWidth(2e3)}),a.setPose("idle").express("neutral"),await l(400);const i=(async()=>{t.dataset.line="premise",t.classList.add("show-line"),await l(2100),t.dataset.line="premise2",await l(2100),t.dataset.line="premise3",await l(2200),t.classList.remove("show-line")})();await s.to({x:1150,y:-560,zoom:s.zoomToFitWidth(2300),duration:2300,easing:g.inOut}),await s.to({x:1600,y:420,zoom:s.zoomToFitWidth(1900),duration:2600,easing:g.inOut}),await i,await l(400),await s.to({x:c.x,y:c.y,zoom:s.zoomToFitWidth(780),duration:1800,easing:g.inOut}),e.root.querySelector(".hero-window").classList.add("is-open"),await l(2500),a.express("curious"),await a.face("right"),await l(600),await s.to({x:c.x,y:c.y,zoom:s.zoomToFitWidth(540),duration:1800,easing:g.inOut});const r=s.to({...m(0,40),zoom:s.fitRoom(1739),duration:2600,easing:g.inOut});await l(1900),e.root.querySelector(".portal").classList.add("is-inside"),e.root.querySelector(".hero-window").classList.add("is-passed"),await r,await s.to({...m(-40,90),zoom:s.fitRoom(1667),duration:1800}),await l(600),await b(a.walkTo(x.taraX-360,{speed:210}),s.to({...m(-220,110),zoom:s.fitRoom(1684),duration:2300})),await l(700),await a.face("right"),await l(500),o.el.classList.add("is-live"),await o.moveTo(360,-160,{duration:1600,easing:g.out}),a.express("curious"),await l(700),await b(o.moveTo(-60,-60,{duration:2e3,easing:g.inOut}),s.to({...m(-160,40),zoom:s.fitRoom(1481),duration:2e3})),a.setPose("reach"),await l(520),await o.moveTo(300,-240,{duration:900,easing:g.out}),a.setPose("idle"),a.express("surprised"),s.shake(5),await l(700),a.express("curious"),await b(a.walkTo(x.taraX-60,{speed:190}),s.to({...m(40,-10),zoom:s.fitRoom(1569),duration:1800})),await l(500),await o.moveTo(150,-170,{duration:1100,easing:g.inOut}),await l(400),o.el.classList.add("is-word"),s.shake(7),a.setPose("surprise"),a.express("surprised"),await l(1400),a.setPose("idle"),a.express("curious"),await l(1600),await s.to({...m(30,10),zoom:s.fitRoom(1778),duration:2e3}),t.classList.add("show-title"),await l(3400),t.classList.add("show-sub"),await l(3e3)}const Ds=[_s,Rs,Os,Fs,Ws,Xs,Gs,Ns,js,Bs];async function Ys(e){for(const s of Ds)await s(e)}const C={width:1600,height:900};class cs{constructor(s){this.el=s,this.x=0,this.y=0,this.scale=1,this.apply()}apply(){this.el.setAttribute("transform",`translate(${this.x} ${this.y}) scale(${this.scale})`)}at(s,a){return this.x=s,this.y=a,this.apply(),this}setScale(s){return this.scale=s,this.apply(),this}setText(s){const a=this.el.querySelector(".sw-text");if(!a)return this;a.textContent=s;const o=Math.max(190,s.length*34+96),t=this.el.querySelector(".sw-plate"),i=this.el.querySelector(".sw-aura");return t&&(t.setAttribute("x",-o/2),t.setAttribute("width",o)),i&&i.setAttribute("rx",o*.78),this}async morphTo(s,{duration:a=900}={}){return this.el.classList.add("is-morphing"),await q({duration:a/2,easing:g.in,onUpdate:()=>{}}),this.setText(s),await q({duration:a/2,easing:g.out,onUpdate:()=>{}}),this.el.classList.remove("is-morphing"),this}scaleTo(s,{duration:a=900,easing:o=g.inOut}={}){const t=this.scale;return q({duration:a,easing:o,onUpdate:i=>{this.scale=t+(s-t)*i,this.apply()}})}moveTo(s,a,{duration:o=1400,easing:t=g.inOut}={}){const i=this.x,r=this.y;return q({duration:o,easing:t,onUpdate:n=>{this.x=i+(s-i)*n,this.y=r+(a-r)*n,this.apply()}})}}function B(e,s){const a=document.createElementNS("http://www.w3.org/2000/svg","g");return s&&a.setAttribute("class",s),a.innerHTML=e,a}function Vs(e){e.innerHTML=`
    <div class="stage">
