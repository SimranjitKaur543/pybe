...
<g class="tara pose-idle" data-mood="neutral">
  ...
  <!-- near side limbs -->
  ${K(17,"leg-near")}
  ${J(48,"arm-near",ws(40,p+104)+ms(40,p+96))}
  ...
  <g class="mithu-perch" transform="translate(46 ${p-14}) scale(0.34)">
    <g class="mithu-hop">${rs()}</g>
  </g>
</g>`}function rs(){return`
<g class="mithu">
  <g class="mithu-tail">
...
</g>`}function Q(e,s,a,o,t="stone"){const i=a/2;return`<g class="${t}">
    <path d="M ${e-i} ${s}
  ...
  </g>`}function G(e,s,a,o){const t=a/2,i=e+t;return`M ${e} ${s+o}
          L ${e} ${s+t*.72}
          Q ${e} ${s} ${i} ${s-t*.28}
          Q ${e+a} ${s} ${e+a} ${s+t*.72}
          L ${e+a} ${s+o} Z`}function _(e,s,a,o,t="arch"){return`<path class="${t}" d="${G(e,s,a,o)}" />`}function W(e,s,a,o,t=0){return`<path class="lit-window" style="animation-delay:${t}s" d="${G(e,s,a,o)}" />`}function O(e,s,a,o,t,i,r="arch"){const n=r==="lit"?W:_;return Array.from({length:a},(h,u)=>r==="lit"?n(e+u*(o+i),s,o,t,u*.83%5):n(e+u*(o+i),s,o,t)).join("")}function N(e,s,a,o=30){const t=o/2;return`<g class="stone">
...
</defs>`}const L={floorY:420,taraX:60,wallX:-1090,doorX:390};function ps(){const{floorY:e}=L;return`
<g class="room">
  <!-- back wall and floor -->
  ...
  ${D(21,8,{x:-900,y:-400,w:1300,h:800})}
</g>`}const v={x0:560,x1:3180,floorY:L.floorY,centreX:1840,askX:1760};function ys(e,s){return`
<g class="fountain">
...
</g>`}function fs(){const{x0:e,x1:s,floorY:a,centreX:o}=v,t=-760;return`
<g class="courtyard">
  ...
  ${ss(1420,t+40,300,a-t-40,1.9)}
  ${ss(2260,t+40,240,a-t-40,1.7)}
  ...
  ${D(41,12,{x:e,y:-760,w:s-e,h:1200})}
...
</g>`}const P={x0:-1560,x1:3520,roofY:-1320,baseY:1010};function bs(){return`
<g class="kingdom">
  ...
  <path class="kd-hills far" d="M -6000 980 Q -3000 600 -600 940 Q 1800 1240 4400 860 Q 7400 520 10000 960
    L 10000 3400 L -6000 3400 Z" />
</g>`}function ks(){const{x0:e,x1:s,roofY:a,baseY:o}=P;return`
<g class="shell">
...
</g>`}function Ss(){const e={x0:-1200,x1:540,y0:-640,y1:L.floorY+120},s={x0:v.x0-20,x1:v.x1+20,y0:-800,y1:v.floorY+200},a={x0:P.x0-80,x1:P.x1+80,y0:P.roofY-160,y1:P.baseY+90};return`
<g class="layer-glows">
  <!-- 1 · her room -->
  <g class="lg lg-local">
...
<g class="trails">
...
</g>`}const c={x:1600,y:300,w:380,h:520,scale:.225},q=980,es=(()=>{let e=12345;const s=()=>(e=(e*9301+49297)%233280)/233280;return Array.from({length:44},()=>({x:-1400+s()*5e3,y:-1500+s()*1900,r:1.6+s()*3.4,d:(s()*6).toFixed(2),layer:s()<.4?"far":"near"}))})();function F(e,s,a,o,t){return`<g class="cloud" style="animation-delay:${o}s; animation-duration:${t}s"
  ...
  </g>`}function H(e,s,a,o){return`<g class="flagpole-g">
...
<g class="sky-group">
  ...
  <g class="stars far">
    ${es.filter(e=>e.layer==="far").map((e,s)=>`<circle class="${s%2?"still":""}" cx="${e.x}" cy="${e.y}" r="${e.r*.7}" style="animation-delay:${e.d}s" />`).join("")}
  </g>
  <g class="stars near">
    ${es.filter(e=>e.layer==="near").map((e,s)=>`<circle class="${s%2?"still":""}" cx="${e.x}" cy="${e.y}" r="${e.r}" style="animation-delay:${e.d}s" />`).join("")}
  </g>
...
<g class="palace">
  ...
  ${Z(2220,700,74,58)}
  ${O(906,800,2,56,150,44,"lit")}
  ${O(2146,800,2,56,150,44,"lit")}
  ...
  ${O(1254,700,2,58,160,52,"lit")}
  ${O(1830,700,2,58,160,52,"lit")}
...
${D(3,14,{x:700,y:200,w:1800,h:800})}`}function zs(){return`<clipPath id="heroClip">
    <path d="M ${c.x-c.w/2} ${c.y+c.h/2+20}
      L ${c.x-c.w/2} ${c.y-70}
      Q ${c.x-c.w/2} ${c.y-c.h/2-20} ${c.x} ${c.y-c.h/2-44}
      Q ${c.x+c.w/2} ${c.y-c.h/2-20} ${c.x+c.w/2} ${c.y-70}
      L ${c.x+c.w/2} ${c.y+c.h/2+20} Z" />
  </clipPath>`}function as(){return`
<g class="spark">
  <g class="spark-trail">
