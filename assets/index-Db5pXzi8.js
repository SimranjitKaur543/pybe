...
<g class="mithu">
  ...
  <g class="mithu-feet">
    ...
    <circle cx="${e}" cy="${s-r-34}" r="7" />
          ...
          Q ${e} ${s} ${i} ${s-a*.28}
          Q ${e+t} ${s} ${e+t} ${s+a*.72}
          L ${e+t} ${s+r} Z`}function K(e,s,t,r,a="arch"){return`<path class="${a}" d="${I(e,s,t,r)}" />`}function H(e,s,t,r,a=0){return`<path class="lit-window" style="animation-delay:${a}s" d="${I(e,s,t,r)}" />`}function Q(e,s,t,r,a,i,o="arch"){const n=o==="lit"?H:K;return Array.from({length:t},(h,w)=>o==="lit"?n(e+w*(r+i),s,r,a,w*.83%5):n(e+w*(r+i),s,r,a)).join("")}function B(e,s,t,r=30){const a=r/2;return`<g class="stone">
...
</defs>`}const x={floorY:420,taraX:60,wallX:-1090,doorX:390};function Ts(){const{floorY:e}=x;return`
<g class="room">
  <!-- back wall and floor -->
...
</g>`}const b={x0:560,x1:3180,floorY:x.floorY,centreX:1840,askX:1760};function Ms(e,s){return`
<g class="fountain">
...
</g>`}function Os(){const e={x0:-1200,x1:540,y0:-640,y1:x.floorY+120},s={x0:b.x0-20,x1:b.x1+20,y0:-800,y1:b.floorY+200},t={x0:Z.x0-80,x1:Z.x1+80,y0:Z.roofY-160,y1:Z.baseY+90};return`
<g class="layer-glows">
  <!-- 1 · her room -->
  <g class="lg lg-local">
...
<g class="palace">
  ...
  ${H(1148,560,48,120,2.1)}
  ${H(1996,560,48,120,.8)}
  ${H(1560,180,74,130,1.6)}
