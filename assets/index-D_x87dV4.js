...
<g class="mithu">
...
</g>`}function ee(s,e,t,o,a="stone"){const i=t/2;return`<g class="${a}">
    <path d="M ${s-i} ${e}
  ...
  </g>`}function le(s,e,t,o){const a=t/2,i=s+a;return`M ${s} ${e+o}
          L ${s} ${e+a*.72}
          Q ${s} ${e} ${i} ${e-a*.28}
          Q ${s+t} ${e} ${s+t} ${e+a*.72}
          L ${s+t} ${e+o} Z`}function we(s,e,t,o,a="arch"){return`<path class="${a}" d="${le(s,e,t,o)}" />`}function se(s,e,t,o,a=0){return`<path class="lit-window" style="animation-delay:${a}s" d="${le(s,e,t,o)}" />`}function _(s,e,t,o,a,i,l="arch"){const c=l==="lit"?se:we;return Array.from({length:t},(h,m)=>l==="lit"?c(s+m*(o+i),e,o,a,m*.83%5):c(s+m*(o+i),e,o,a)).join("")}function ne(s,e,t,o=30){const a=o/2;return`<g class="stone">
...
</defs>`}const T={floorY:420,taraX:60,wallX:-1090,doorX:390};function He(){const{floorY:s}=T;return`
<g class="room">
  <!-- back wall and floor -->
...
</g>`}const M={x0:560,x1:3180,floorY:T.floorY,centreX:1840,askX:1760};function Ue(s,e){return`
<g class="fountain">
...
</g>`}function Be(){const{x0:s,x1:e,floorY:t,centreX:o}=M,a=-760;return`
<g class="courtyard">
...
</g>`}const B={x0:-1560,x1:3520,roofY:-1320,baseY:1010};function Ke(){return`
<g class="kingdom">
  ...
  <path class="kd-hills far" d="M -6000 980 Q -3000 600 -600 940 Q 1800 1240 4400 860 Q 7400 520 10000 960
    L 10000 3400 L -6000 3400 Z" />
</g>`}function Ve(){const{x0:s,x1:e,roofY:t,baseY:o}=B;return`
<g class="shell">
...
</g>`}function Je(){const s={x0:-1200,x1:540,y0:-640,y1:T.floorY+120},e={x0:M.x0-20,x1:M.x1+20,y0:-800,y1:M.floorY+200},t={x0:B.x0-80,x1:B.x1+80,y0:B.roofY-160,y1:B.baseY+90};return`
<g class="layer-glows">
  <!-- 1 · her room -->
  <g class="lg lg-local">
  ...
  <g class="lg lg-enclosing">
    ...
    <path class="lg-link" d="M ${s.x1} ${T.floorY-200} L ${e.x0} ${T.floorY-200}" />
  </g>
...
</g>`}const n={x:1600,y:300,w:380,h:520,scale:.225},P=980,be=(()=>{let s=12345;const e=()=>(s=(s*9301+49297)%233280)/233280;return Array.from({length:44},()=>({x:-1400+e()*5e3,y:-1500+e()*1900,r:1.6+e()*3.4,d:(e()*6).toFixed(2),layer:e()<.4?"far":"near"}))})();function J(s,e,t,o,a){return`<g class="cloud" style="animation-delay:${o}s; animation-duration:${a}s"
...
<g class="sky-group">
  ...
  <g class="stars far">
    ${be.filter(s=>s.layer==="far").map((s,e)=>`<circle class="${e%2?"still":""}" cx="${s.x}" cy="${s.y}" r="${s.r*.7}" style="animation-delay:${s.d}s" />`).join("")}
  </g>
  <g class="stars near">
    ${be.filter(s=>s.layer==="near").map((s,e)=>`<circle class="${e%2?"still":""}" cx="${s.x}" cy="${s.y}" r="${s.r}" style="animation-delay:${s.d}s" />`).join("")}
  </g>

  <g class="clouds">
    ${J(-900,-1180,1.1,0,96)}
    ${J(-1700,-760,.8,16,122)}
    ${J(-500,-420,1.35,40,148)}
    ${J(-2100,-1420,.9,62,134)}
  </g>
</g>
...
<g class="palace">
  <!-- outer wings -->
  <rect class="stone" x="880" y="700" width="200" height="${P-700}" rx="6" />
  ${K(980,700,74,58)}
  <rect class="stone" x="2120" y="700" width="200" height="${P-700}" rx="6" />
  ${K(2220,700,74,58)}
  ${_(906,800,2,56,150,44,"lit")}
  ${_(2146,800,2,56,150,44,"lit")}

  <!-- flanking towers -->
  <rect class="stone" x="1120" y="420" width="112" height="${P-420}" rx="6" />
  ${ee(1176,420,132,108)}
  <rect class="stone" x="1968" y="420" width="112" height="${P-420}" rx="6" />
  ${ee(2024,420,132,108)}
  ${he(1176,306,62,0)}
  ${he(2024,306,62,1.3)}

  <!-- great hall -->
  <rect class="stone" x="1220" y="520" width="760" height="${P-520}" rx="8" />
  ...
  ${_(1254,700,2,58,160,52,"lit")}
  ${_(1830,700,2,58,160,52,"lit")}
  ${se(1148,560,48,120,2.1)}
  ${se(1996,560,48,120,.8)}
  ${se(1560,180,74,130,1.6)}

  <!-- plinth -->
  <rect class="plinth" x="820" y="${P-28}" width="1560" height="40" rx="8" />
</g>

<rect class="ground" x="-2600" y="${P}" width="8000" height="900" />
  ...
  <g class="portal" clip-path="url(#heroClip)">
    <g transform="translate(${n.x} ${n.y}) scale(${n.scale})">
      ...
      <g class="magic-labels">
        ${X("local","Local",-330,-900,"inside one function")}
        ${X("enclosing","Enclosing",1870,-1120,"a function written inside another")}
        ${X("global","Global",980,-1760,"the whole file")}
        ${X("builtin","Built-in",980,-2520,"names Python already knows")}
      </g>
      ${ts()}
      ${es()}
      ${ss()}
      <g class="shadow-tag">
        ${X("shadow","shadowing",-300,-900)}
      </g>
...
</g>`}function Se(s){const e=Math.max(190,s.length*30+84);return`
  ...
  <g class="sw-motes">
    ${[[-e*.4,-28,0],[e*.34,-34,.8],[-e*.2,36,1.6],[e*.44,26,2.3],[6,-52,1.1],[-e*.46,14,2.9]].map(([t,o,a])=>`<circle cx="${t}" cy="${o}" r="3.6" style="animation-delay:${a}s" />`).join("")}
      ...
      style="--fx:${(Math.cos(o)*a).toFixed(1)}px; --fy:${(Math.sin(o)*a*.6).toFixed(1)}px;
             animation-delay:${(t()*1.1).toFixed(2)}s" />`}).join("")}</g>`}const w=(s,e)=>({x:n.x+s*n.scale,y:n.y+e*n.scale});function D(s,e){const t=s.root.querySelector(".stage");t&&t.classList.toggle("is-deciding",e);const o=s.root.querySelector(".tara");o&&o.classList.toggle("is-attending",e)}async function ce(s,e="curious",{nod:t=!1,ms:o=900}={}){const a=s.root.querySelector(".tara");s.tara?.express?.(e),t&&a&&a.classList.add("mithu-alert"),await new Promise(i=>setTimeout(i,R?0:o)),t&&a&&a.classList.remove("mithu-alert")}function te(s,{question:e,options:t,kind:o="choice"}={}){const a=s.root.querySelector(".interact"),i=F();return new Promise(l=>{const c=document.createElement("div");c.className=`ask ask-${o}`,c.setAttribute("role","group"),c.setAttribute("aria-label",e);const h=document.createElement("p");h.className="ask-q",h.textContent=e,c.appendChild(h);const m=document.createElement("div");m.className="ask-options",c.appendChild(m);let u=!1;const p=()=>{u||(u=!0,D(s,!1),x(),c.classList.add("is-going"),setTimeout(()=>c.remove(),R?0:420))},k=v=>{u||([...m.children].forEach(b=>b.classList.toggle("is-chosen",b.dataset.value===String(v.value))),p(),i===F()&&l(v.value))};t.forEach((v,b)=>{const y=document.createElement("button");y.type="button",y.className="choice",y.dataset.value=String(v.value),y.innerHTML=`<span class="choice-label"></span>${v.note?'<span class="choice-note"></span>':""}`,y.querySelector(".choice-label").textContent=v.label,v.note&&(y.querySelector(".choice-note").textContent=v.note),y.addEventListener("click",()=>k(v)),m.appendChild(y),b===0&&requestAnimationFrame(()=>y.focus({preventScroll:!0}))});const x=pe(()=>{u=!0,c.remove()});D(s,!0),a.appendChild(c),requestAnimationFrame(()=>c.classList.add("is-open"))})}async function ae(s,e,t=2600){const o=s.root.querySelector(".interact"),a=F(),i=document.createElement("p");i.className="ask-said",i.setAttribute("role","status"),i.textContent=e,o.appendChild(i);const l=pe(()=>i.remove());requestAnimationFrame(()=>i.classList.add("is-open")),await new Promise(c=>setTimeout(c,R?0:t)),l(),i.classList.remove("is-open"),setTimeout(()=>i.remove(),R?0:420),a!==F()&&await new Promise(()=>{})}async function Pe(s,e){const{code:t=[],question:o,options:a,answer:i,hints:l=[],feedback:c={},reveal:h}=e,m=s.root.querySelector(".interact"),u=F();let p=0,k=!1;for(;;){const x=await new Promise(b=>{const y=document.createElement("div");if(y.className="ask ask-predict",y.setAttribute("role","group"),y.setAttribute("aria-label",o),t.length){const S=document.createElement("pre");S.className="ask-code",S.textContent=t.join(`
`),y.appendChild(S)}const A=document.createElement("p");A.className="ask-q",A.textContent=o,y.appendChild(A);const N=document.createElement("div");N.className="ask-options",y.appendChild(N);const j=document.createElement("div");j.className="hint-rail",y.appendChild(j);let L=0,f=null;l.length&&(f=document.createElement("button"),f.type="button",f.className="hintbtn",f.innerHTML='<span aria-hidden="true">💡</span> Hint',f.addEventListener("click",()=>{k=!0;const S=document.createElement("p");S.className="hint",S.setAttribute("role","status"),S.textContent=l[L],j.appendChild(S),requestAnimationFrame(()=>S.classList.add("is-open")),L+=1,L>=l.length&&(f.disabled=!0)}),y.appendChild(f));let G=!1;const Re=S=>{G||(G=!0,D(s,!1),Fe(),[...N.children].forEach(Y=>Y.classList.toggle("is-chosen",Y.dataset.value===String(S.value))),y.classList.add("is-going"),setTimeout(()=>y.remove(),R?0:420),u===F()&&b(S.value))};a.forEach((S,Y)=>{const O=document.createElement("button");O.type="button",O.className="choice choice-tight",O.dataset.value=String(S.value),O.textContent=S.label,O.addEventListener("click",()=>Re(S)),N.appendChild(O),Y===0&&requestAnimationFrame(()=>O.focus({preventScroll:!0}))});const Fe=pe(()=>{G=!0,D(s,!1),y.remove()});D(s,!0),m.appendChild(y),requestAnimationFrame(()=>y.classList.add("is-open"))});if(p+=1,x===i)return await ae(s,c[x]||"That is it.",2400),{value:x,correct:!0,attempts:p,usedHint:k};if(await ae(s,c[x]||"Not quite — look again at where it was made.",2600),p>=2)return h&&await ae(s,h,3e3),{value:x,correct:!1,attempts:p,usedHint:k}}}const W={readyToWhisper:{question:"Tara has a secret word she wants to try.",options:[{value:"go",label:"Let her whisper it",note:"and see where it goes"}]},whatToDo:{question:"Tara has whispered a secret. What should she do?",options:[{value:"outside",label:"Take it outside",note:"see if it follows"},{value:"stay",label:"Keep it in the room",note:"say it again"}]},whereDidItGo:{question:"Her secret did not answer out here. Where is it?",options:[{value:"room",label:"Still in her room"},{value:"followed",label:"It followed her out"},{value:"gone",label:"It disappeared"}],answer:"room",feedback:{room:"Exactly. It never left the room it was made in.",followed:"Almost — that is what it feels like. Watch where it actually is.",gone:"Not gone. Look back at the room she came from."}},shadowPredict:{code:['name = "Mithu"',"","def room():",'    name = "Tara"',"    print(name)","","room()"],question:"What does this print?",options:[{value:"Tara",label:"Tara"},{value:"Mithu",label:"Mithu"},{value:"error",label:"An error"}],answer:"Tara",hints:["Look at where each name was made.","Is Tara inside the room, or outside it, when she reads it?"],feedback:{Tara:"Yes. Inside the room, her own name is the nearer one.",Mithu:"Almost. The palace still says Mithu — but Tara made her own copy inside.",error:"No error here. Both names exist; the question is which one is nearer."},reveal:"It prints Tara. The name made inside the room hides the one outside it."},errorPredict:{code:['name = "Mithu"',"","def room():","    print(name)",'    name = "Tara"',"","room()"],question:"And this one?",options:[{value:"error",label:"An error"},{value:"Mithu",label:"Mithu"},{value:"Tara",label:"Tara"}],answer:"error",hints:["Python reads the whole room before it runs a single line of it.","The room assigns to name somewhere. What does that make the name, everywhere in the room?"],feedback:{error:"Yes — UnboundLocalError. The room owns the name before it has a value.",Mithu:"That is the trap. Because the room assigns to name lower down, it never looks outside at all.",Tara:"Not yet — that line has not run when print is reached."},reveal:"It raises UnboundLocalError: the room claimed name the moment it was written, so there is nothing outside to fall back to."}},qe={x:26,y:176},H=T.wallX;async function rs(s){const{camera:e,tara:t,spark:o,hers:a,ui:i,root:l}=s,c=l.querySelector(".room"),h=l.querySelector(".wall-ripple");i.classList.contains("show-title")&&(i.classList.add("title-out"),await r(900),i.classList.remove("show-title","show-sub","title-out")),o.moveTo(470,-330,{duration:1500,easing:g.inOut}),l.querySelector(".spark-slot").classList.add("is-dimmed"),await e.to({...w(t.x-30,150),zoom:e.fitRoom(1569),duration:1400}),t.express("curious"),await r(500),await e.to({...w(t.x+10,70),zoom:e.fitRoom(1067),duration:1400}),await r(400),await te(s,W.readyToWhisper),t.setPose("whisper"),await r(500),a.at(t.x+qe.x,t.y-qe.y).setScale(.06),a.el.classList.add("is-live"),await r(300),await a.scaleTo(1,{duration:1e3,easing:g.back}),a.el.classList.add("is-word"),await r(400),t.setPose("idle"),t.express("happy"),await C(a.moveTo(t.x+120,t.y-330,{duration:1400,easing:g.out}),e.to({...w(t.x+60,-60),zoom:e.fitRoom(1356),duration:1400})),await r(400),t.express("curious"),e.follow(a,{map:(u,p)=>w(u,p),offsetY:60,lag:.035}),await a.moveTo(-180,-400,{duration:1400,easing:g.inOut}),await a.moveTo(-430,-250,{duration:1400,easing:g.inOut}),await C(t.walkTo(-320,{speed:200}),a.moveTo(-700,-320,{duration:1400,easing:g.inOut})),await a.moveTo(H,-300,{duration:1400,easing:g.in}),h.setAttribute("transform",`translate(${H-20} -300)`),h.classList.remove("is-hit"),h.getBoundingClientRect(),h.classList.add("is-hit"),a.el.classList.add("is-bouncing"),e.shake(9),await a.moveTo(H+250,-350,{duration:700,easing:g.out}),a.el.classList.remove("is-bouncing"),e.unfollow(),await e.to({...w(-520,-190),zoom:e.fitRoom(1455),duration:1200}),t.express("surprised"),await r(500),t.express("curious"),e.follow(a,{map:(u,p)=>w(u,p),offsetY:40,lag:.03}),await a.moveTo(H+30,-270,{duration:1400,easing:g.inOut}),h.classList.remove("is-hit"),h.getBoundingClientRect(),h.setAttribute("transform",`translate(${H-10} -270)`),h.classList.add("is-hit"),a.el.classList.add("is-straining"),e.shake(5),await r(600),a.el.classList.add("is-fading"),await r(900),a.el.classList.remove("is-live","is-word","is-straining","is-fading"),e.unfollow(),await e.to({...w(-560,-60),zoom:e.fitRoom(1379),duration:1400}),t.express("confused"),await r(600),await t.walkTo(-760,{speed:150}),await t.face("left"),t.setPose("touch"),c.classList.add("wall-felt"),await r(1e3),l.querySelector(".tara").classList.add("mithu-alert"),await r(700),t.setPose("idle"),await t.face("right"),t.express("curious"),await e.to({...w(-420,-40),zoom:e.fitRoom(1905),duration:1400}),await r(400),l.querySelector(".room-door").classList.add("is-noticed"),await r(800),i.dataset.line="far",i.classList.add("show-line"),await r(4e3),i.classList.remove("show-line"),c.classList.remove("wall-felt"),l.querySelector(".tara").classList.remove("mithu-alert"),await r(300),s.journey.at("local"),await s.journey.flash(1800);let m=await te(s,W.whatToDo);for(await ce(s,m==="outside"?"curious":"neutral",{ms:700});m==="stay";)await e.to({...w(t.x-20,60),zoom:e.fitRoom(1330),duration:1200}),t.setPose("whisper"),await r(700),t.setPose("idle"),a.el.classList.add("is-beckoning"),await r(900),a.el.classList.remove("is-beckoning"),c.classList.add("wall-felt"),await r(700),c.classList.remove("wall-felt"),t.express("confused"),await r(900),m=await te(s,{question:"The same wall, every time. Should she try outside?",options:[{value:"outside",label:"Take it outside",note:"find out why"},{value:"stay",label:"Try once more"}]});l.querySelector(".room-door").classList.remove("is-noticed"),await r(300)}async function ls(s){const{camera:e,tara:t,hers:o,ui:a,root:i}=s,l=i.querySelector(".room-door"),c=i.querySelector(".ask-prompt"),h=i.querySelector(".ask-anchor"),m=i.querySelector(".ask-speech"),u=i.querySelector(".ask-speech-anchor"),p=i.querySelector(".q-motes");o.at(-620,-240).setScale(1),o.el.classList.add("is-live","is-word","is-homebound"),await r(400),i.querySelector(".tara").classList.add("mithu-alert"),await r(500),t.express("curious"),await t.face("right"),await r(300),l.classList.add("is-open"),await r(500),e.follow(t,{map:(x,v)=>w(x,v),offsetY:-150,lag:.028}),await t.walkTo(T.doorX+40,{speed:210}),await r(400),await t.walkTo(M.x0+300,{speed:200}),e.unfollow(),await e.to({...w(M.centreX-260,-120),zoom:e.fitRoom(3077),duration:2300,easing:g.inOut}),t.express("surprised"),await r(500),await t.face("left"),await r(300),await t.face("right"),t.express("curious"),await r(400),h.setAttribute("transform",`translate(${M.askX} -470)`),await e.to({...w(M.askX,-250),zoom:e.fitRoom(2150),duration:1600,easing:g.inOut}),await t.face("right"),c.classList.add("is-offered"),await new Promise(x=>{const v=setTimeout(()=>c.classList.add("is-urging"),7e3),b=()=>{clearTimeout(v),c.classList.remove("is-urging"),c.removeEventListener("click",b),c.removeEventListener("keydown",y),x()},y=A=>{(A.key==="Enter"||A.key===" ")&&(A.preventDefault(),b())};c.addEventListener("click",b),c.addEventListener("keydown",y)}),c.classList.remove("is-offered"),c.classList.add("is-taken"),await C(t.walkTo(M.askX,{speed:190}),e.to({...w(M.askX+60,-180),zoom:e.fitRoom(2667),duration:1700})),await r(300),await t.face("left"),await r(300),t.setPose("reach"),t.express("curious"),u.setAttribute("transform",`translate(${M.askX+30} -330)`),m.classList.add("is-spoken"),await r(1100),t.setPose("idle"),m.classList.remove("is-spoken"),p.setAttribute("transform",`translate(${M.askX+40} -420)`),p.classList.add("is-asking"),i.querySelector(".courtyard").classList.add("is-hushed"),await r(1100),p.classList.remove("is-asking"),t.express("confused"),i.querySelector(".tara").classList.add("mithu-alert"),await r(700);const k=await te(s,W.whereDidItGo);await ce(s,k===W.whereDidItGo.answer?"happy":"confused",{nod:!0,ms:800}),await ae(s,W.whereDidItGo.feedback[k],2400),await t.face("left"),await r(300),await e.to({...w(700,-180),zoom:e.fitRoom(4706),duration:2300,easing:g.inOut}),o.el.classList.add("is-beckoning"),await r(1100),a.dataset.line="born",a.classList.add("show-line"),await r(4800),a.classList.remove("show-line"),await r(400),s.journey.done("local").at("enclosing"),i.querySelector(".tara").classList.remove("mithu-alert"),i.querySelector(".courtyard").classList.remove("is-hushed"),o.el.classList.remove("is-beckoning")}const ns=[{id:"local",cls:"lg-local"},{id:"enclosing",cls:"lg-enclosing"},{id:"global",cls:"lg-global"},{id:"builtin",cls:"lg-builtin"}];async function cs(s){const{camera:e,tara:t,code:o,ui:a,root:i}=s,l=i.querySelector(".layer-glows"),c=i.querySelector(".magic-labels");t.setPose("idle").express("curious"),await e.to({...w(900,-420),zoom:e.zoomToFitWidth(1080),duration:2300,easing:g.inOut}),await r(300),i.querySelector(".portal").classList.add("show-shell"),await e.to({...w(980,-940),zoom:e.zoomToFitWidth(1760),duration:2600,easing:g.inOut}),await r(500),l.classList.add("is-live");for(const h of ns)i.querySelector(`.${h.cls}`).classList.add("is-lit"),await r(400),c.querySelector(`.mlabel-${h.id}`).classList.add("is-named"),await r(900);await r(500),a.dataset.line="names",a.classList.add("show-line"),await r(3600),a.classList.remove("show-line"),a.dataset.line="legb",a.classList.add("show-line"),await r(4600),a.classList.remove("show-line"),o.dock(),await o.write(['name = "Mithu"'],{stagger:0}),o.note(0,"Global — out in the open palace"),await r(1600)}const ds=[{cls:"lg-local",found:!1,note:"not in room() — look outward"},{cls:"lg-enclosing",found:!1,note:"not in the enclosing space either"},{cls:"lg-global",found:!0,note:"found it — the palace name"}];async function hs(s){const{camera:e,tara:t,spark:o,hers:a,code:i,ui:l,root:c}=s,h=c.querySelector(".layer-glows"),m=c.querySelector(".tara");c.querySelectorAll(".mlabel").forEach(u=>u.classList.remove("is-named")),c.querySelectorAll(".lg").forEach(u=>u.classList.remove("is-lit")),o.setText("MITHU").at(1900,-1180).setScale(1),o.el.classList.remove("is-dimmed"),o.el.classList.add("is-live","is-word","is-outer"),await e.to({...w(760,-560),zoom:e.zoomToFitWidth(1180),duration:1700}),t.express("curious"),await r(500),m.classList.add("mithu-alert"),l.dataset.line="wider",l.classList.add("show-line"),await r(3400),l.classList.remove("show-line"),m.classList.remove("mithu-alert"),i.clearNotes(),await i.append(["","def room():","    print(name)"],{stagger:380}),i.focus(3),await r(500),m.classList.add("has-lantern"),await r(500),h.classList.add("is-live","is-searching");for(const u of ds){const p=c.querySelector(`.${u.cls}`);p.classList.add("is-lit","is-probing"),i.note(3,u.note),u.cls==="lg-enclosing"&&C(t.walkTo(M.centreX-200,{speed:230}),e.to({...w(900,-640),zoom:e.zoomToFitWidth(1420),duration:1800})),u.cls==="lg-global"&&e.to({...w(980,-860),zoom:e.zoomToFitWidth(1780),duration:1900}),await r(1100),u.found?(p.classList.remove("is-probing"),p.classList.add("is-found"),o.el.classList.add("is-answering"),i.mark(3,"is-ok"),t.express("happy"),e.shake(5),await r(1400)):(p.classList.remove("is-probing"),p.classList.add("is-empty"),await r(300))}await r(800),i.unmark("is-ok"),i.note(3,"and print? found in the outermost ring"),c.querySelector(".lg-builtin").classList.add("is-lit","is-found"),c.querySelector(".mlabel-builtin").classList.add("is-named"),await r(1e3),l.dataset.line="builtin",l.classList.add("show-line"),await r(4400),l.classList.remove("show-line"),c.querySelector(".mlabel-builtin").classList.remove("is-named"),c.querySelectorAll(".lg").forEach(u=>u.classList.remove("is-empty","is-found")),h.classList.remove("is-searching"),o.el.classList.remove("is-answering"),i.unfocus(),i.clearNotes()}const ue={x:-560,y:-300};async function us(s){const{camera:e,tara:t,spark:o,hers:a,code:i,ui:l,root:c}=s,h=c.querySelector(".tara");await C(t.walkTo(T.taraX-120,{speed:240}),e.to({...w(-120,-240),zoom:e.zoomToFitWidth(760),duration:2200})),h.classList.remove("has-lantern"),await t.face("right"),t.express("curious"),await r(500),t.setPose("whisper"),await r(500),a.setText("MITHU").at(ue.x,ue.y).setScale(.05),a.el.classList.remove("is-homebound","is-beckoning"),a.el.classList.add("is-live","is-inner"),await a.scaleTo(1,{duration:1e3,easing:g.back}),a.el.classList.add("is-word"),t.setPose("idle"),await i.retype(3,'    name = "Tara"'),i.mark(3,"is-claim"),i.note(3,"assigning MAKES a new local name"),await i.append(["    print(name)"],{stagger:0}),await r(1e3),await e.to({...w(560,-620),zoom:e.zoomToFitWidth(1500),duration:1800}),await r(800),await e.to({...w(-260,-260),zoom:e.zoomToFitWidth(820),duration:1600}),await t.walkTo(ue.x+250,{speed:200}),await t.face("left"),t.setPose("reach"),await r(300),a.el.classList.add("is-touched"),e.shake(4),await a.morphTo("TARA",{duration:1100}),a.el.classList.remove("is-touched"),t.setPose("idle"),t.express("surprised"),await r(500),await e.to({...w(620,-640),zoom:e.zoomToFitWidth(1560),duration:1800}),o.el.classList.add("is-answering"),i.note(0,"untouched"),await r(1100),o.el.classList.remove("is-answering"),i.note(0,""),t.express("happy"),h.classList.add("mithu-alert"),await r(800),h.classList.remove("mithu-alert");const m=c.querySelector(".mlabel-local");m.classList.add("is-named","is-inline"),await r(1700),i.unmark("is-claim"),i.focus(3),await r(700),l.dataset.line="readassign",l.classList.add("show-line"),await r(4400),l.classList.remove("show-line"),i.unfocus();const u=await Pe(s,W.shadowPredict);await ce(s,u.correct?"happy":"curious",{nod:!0,ms:800}),await e.to({...w(-160,-420),zoom:e.zoomToFitWidth(1120),duration:1800}),await r(400),c.querySelector(".reach").classList.add("show-shadow"),o.el.classList.add("is-shadowed"),a.el.classList.add("is-shadowing"),i.focus(4),i.note(4,"finds the local one; outer is hidden"),await r(1400),l.dataset.line="hides",l.classList.add("show-line"),await r(4200),l.classList.remove("show-line"),await r(500),i.unfocus(),i.clearNotes(),m.classList.remove("is-inline","is-named")}async function ms(s){const{camera:e,tara:t,spark:o,hers:a,code:i,ui:l,root:c}=s,h=c.querySelector(".tara"),m=c.querySelector(".reach");m.classList.remove("show-shadow"),o.el.classList.remove("is-shadowed"),a.el.classList.remove("is-shadowing"),await r(400),await e.to({...w(400,-620),zoom:e.zoomToFitWidth(1420),duration:1800}),await t.face("right"),t.express("curious"),await r(700),h.classList.add("mithu-alert"),l.dataset.line="speak",l.classList.add("show-line"),await r(3600),l.classList.remove("show-line"),h.classList.remove("mithu-alert"),await e.to({...w(-200,-300),zoom:e.zoomToFitWidth(880),duration:1600}),h.classList.add("has-megaphone"),await r(500),t.setPose("reach"),t.express("happy"),await r(500),await e.to({...w(700,-700),zoom:e.zoomToFitWidth(1620),duration:1700}),await i.retype(3,"    global name"),i.mark(3,"is-claim"),i.note(3,"rebinds the palace name, not a local one"),await i.append(['    name = "Tara"'],{stagger:0}),await r(800),m.classList.add("show-global"),e.shake(6),await r(1100),o.el.classList.add("is-touched"),await o.morphTo("TARA",{duration:1200}),o.el.classList.remove("is-touched"),o.el.classList.add("is-answering"),e.shake(8),await r(1100),t.setPose("idle"),o.el.classList.remove("is-answering"),m.classList.remove("show-global"),h.classList.remove("has-megaphone"),await r(500);const u=c.querySelector(".mlabel-global");u.classList.add("is-named","is-inline"),await r(1700),u.classList.remove("is-inline","is-named"),await e.to({...w(260,-420),zoom:e.zoomToFitWidth(1240),duration:1700}),h.classList.add("mithu-alert"),i.unmark("is-claim"),i.clearNotes(),await i.write(["def palace():",'    name = "Mithu"',"","    def room():","        nonlocal name",'        name = "Tara"'],{stagger:300}),i.focus(4),i.note(4,"reaches the ENCLOSING room only"),m.classList.add("show-nonlocal"),await r(1100),l.dataset.line="nonlocal",l.classList.add("show-line"),await r(4600),l.classList.remove("show-line"),m.classList.remove("show-nonlocal"),h.classList.remove("mithu-alert"),i.unfocus(),i.clearNotes(),t.express("happy"),await r(700)}async function ws(s){const{camera:e,tara:t,spark:o,hers:a,code:i,ui:l,root:c}=s,h=c.querySelector(".tara"),m=c.querySelector(".trails"),u=c.querySelector(".error-spell");o.setText("MITHU").at(1900,-1180),o.el.classList.add("is-live","is-word","is-outer"),o.el.classList.remove("is-shadowed"),a.el.classList.remove("is-word","is-live","is-inner","is-shadowing","is-hollow"),await e.to({...w(40,-140),zoom:e.fitRoom(1500),duration:2e3}),await t.face("right"),t.express("curious"),await i.write(['name = "Mithu"',"","def room():","    print(name)",'    name = "Tara"'],{stagger:300}),await r(500),m.classList.add("show-out"),o.el.classList.add("is-answering"),await r(1100),m.classList.remove("show-out"),o.el.classList.remove("is-answering"),await r(400);const p=await Pe(s,W.errorPredict);await ce(s,p.correct?"happy":"surprised",{nod:!0,ms:850}),await e.to({...w(-380,-200),zoom:e.fitRoom(1e3),duration:1600}),await t.face("left"),t.setPose("reach"),await r(400),a.setText("name").at(-560,-300).setScale(.1),a.el.classList.add("is-live","is-hollow"),await a.scaleTo(1,{duration:900,easing:g.back}),a.el.classList.add("is-word"),e.shake(4),t.setPose("idle"),await r(700),a.el.classList.add("is-claimed"),i.focus(4),i.note(4,"seen first — so name is local everywhere"),await r(1400),t.setPose("reach"),t.express("curious"),m.classList.add("show-local"),i.focus(3),i.note(3,"runs first — local name still empty"),await r(1e3),a.el.classList.add("is-hollow-pulse"),await r(800),m.classList.remove("show-local"),await e.to({...w(140,-300),zoom:e.fitRoom(1700),duration:1600}),m.classList.add("show-blocked"),await r(500),m.classList.add("is-barred"),e.shake(9),t.setPose("surprise"),t.express("surprised"),h.classList.add("mithu-alert"),await r(800),m.classList.remove("show-blocked","is-barred"),c.querySelector(".stage").classList.add("is-darkened"),u.setAttribute("transform","translate(120 -760)"),u.classList.add("is-cast"),i.mark(3,"is-error"),i.focus(3),e.shake(12),await r(1400),l.dataset.line="claimed",l.classList.add("show-line"),await r(4200),l.classList.remove("show-line"),await r(300),l.dataset.line="lookedthere",l.classList.add("show-line"),await r(4400),l.classList.remove("show-line"),await r(800),u.classList.remove("is-cast"),c.querySelector(".stage").classList.remove("is-darkened"),h.classList.remove("mithu-alert"),t.setPose("idle"),a.el.classList.remove("is-hollow-pulse"),i.unmark("is-error"),i.unfocus(),i.clearNotes(),await r(500)}const Te={x:620,y:-1180};async function ps(s){const{camera:e,tara:t,spark:o,hers:a,code:i,ui:l,root:c}=s,h=c.querySelector(".tara"),m=c.querySelector(".trails"),u=c.querySelector(".perch-stand"),p=c.querySelector(".error-spell");await C(t.walkTo(T.taraX-220,{speed:200}),e.to({...w(-120,-260),zoom:e.fitRoom(1300),duration:1900})),await t.face("right"),t.setPose("sit"),t.express("curious"),u.setAttribute("transform",`translate(${T.taraX+190} ${T.floorY})`),u.classList.add("is-up"),h.classList.add("mithu-away"),await r(500),l.dataset.line="rules",l.classList.add("show-line"),await r(3800),l.classList.remove("show-line"),i.at(Te.x,Te.y),i.undock(),await i.clear({duration:400}),await e.to({...w(520,-760),zoom:e.fitRoom(2100),duration:1800}),a.el.classList.remove("is-word","is-live","is-hollow","is-claimed","is-hollow-pulse","is-inner","is-shadowing","is-clearing"),o.setText("MITHU").at(1900,-1180),o.el.classList.add("is-live","is-word","is-outer"),await i.write(['name = "Mithu"',"","def room():","    print(name)"]),await r(300),i.focus(3),m.classList.add("show-out"),await r(500),o.el.classList.add("is-answering"),await r(700),l.dataset.line="lookout",l.classList.add("show-line"),await r(3900),l.classList.remove("show-line"),m.classList.remove("show-out"),o.el.classList.remove("is-answering"),i.unfocus(),await i.clear(),await i.write(['name = "Mithu"',"","def room():",'    name = "Tara"',"    print(name)"]),await r(300),i.focus(3),a.setText("TARA").at(-560,-300).setScale(.1),a.el.classList.remove("is-hollow","is-claimed"),a.el.classList.add("is-live","is-inner"),await a.scaleTo(1,{duration:900,easing:g.back}),a.el.classList.add("is-word"),await r(400),i.focus(4),m.classList.add("show-local"),a.el.classList.add("is-shadowing"),o.el.classList.add("is-shadowed"),await r(800),l.dataset.line="hides",l.classList.add("show-line"),await r(3800),l.classList.remove("show-line");const k=c.querySelector(".shadow-tag .mlabel");k.classList.add("is-named"),await r(1100),k.classList.remove("is-named"),m.classList.remove("show-local"),o.el.classList.remove("is-shadowed"),a.el.classList.remove("is-shadowing"),i.unfocus(),await i.clear(),await i.write(['name = "Mithu"',"","def room():","    print(name)",'    name = "Tara"']),await r(300),i.focus(4),await r(500),a.setText("name").at(-560,-300).setScale(.1),a.el.classList.remove("is-inner"),a.el.classList.add("is-live","is-hollow"),await a.scaleTo(1,{duration:800,easing:g.back}),a.el.classList.add("is-word","is-claimed"),e.shake(4),await r(700),i.focus(3),m.classList.add("show-blocked"),a.el.classList.add("is-hollow-pulse"),await r(500),m.classList.add("is-barred"),e.shake(8),await r(500),m.classList.remove("show-blocked","is-barred"),p.setAttribute("transform","translate(620 -320)"),c.querySelector(".stage").classList.add("is-darkened"),p.classList.add("is-cast"),i.mark(3,"is-error"),await r(900),l.dataset.line="assigns",l.classList.add("show-line"),await r(4400),l.classList.remove("show-line"),await r(300),l.dataset.line="novalue",l.classList.add("show-line"),await r(4e3),l.classList.remove("show-line"),p.classList.remove("is-cast"),c.querySelector(".stage").classList.remove("is-darkened"),i.unfocus(),i.unmark("is-error"),await i.clear(),a.el.classList.remove("is-hollow-pulse"),await i.write(["len = 5",'print(len("palace"))'],{stagger:380}),await r(300),i.focus(0),i.note(0,"this hides the built-in len"),c.querySelector(".lg-builtin").classList.add("is-lit"),c.querySelector(".mlabel-builtin").classList.add("is-named"),await r(900),i.focus(1),i.mark(1,"is-error"),i.note(1,"TypeError — 5 is not a function"),e.shake(6),t.express("surprised"),await r(1100),l.dataset.line="shadowbuiltin",l.classList.add("show-line"),await r(4400),l.classList.remove("show-line"),c.querySelector(".mlabel-builtin").classList.remove("is-named"),c.querySelector(".lg-builtin").classList.remove("is-lit"),i.unfocus(),i.unmark("is-error"),i.clearNotes(),await i.clear(),t.express("curious"),await e.to({...w(-140,-180),zoom:e.fitRoom(1500),duration:1600}),t.setPose("idle");for(let x=0;x<2;x+=1)await t.walkTo(T.taraX-160,{speed:240}),a.setText("TARA").at(-560,-300).setScale(.1),a.el.classList.remove("is-hollow","is-claimed"),a.el.classList.add("is-live","is-inner"),await a.scaleTo(1,{duration:700,easing:g.back}),a.el.classList.add("is-word"),await r(500),await t.walkTo(T.doorX+60,{speed:240}),a.el.classList.add("is-clearing"),await r(400),a.el.classList.remove("is-live","is-word","is-clearing","is-inner"),await r(300);l.dataset.line="freshcall",l.classList.add("show-line"),await r(4e3),l.classList.remove("show-line"),await t.walkTo(T.taraX-160,{speed:220}),await t.face("right"),t.express("happy"),await e.to({...w(980,-940),zoom:e.zoomToFitWidth(1760),duration:2400}),c.querySelector(".layer-glows").classList.add("is-live");for(const x of["local","enclosing","global","builtin"])c.querySelector(`.lg-${x}`).classList.add("is-lit"),await r(300);await r(500),l.dataset.line="begins",l.classList.add("show-line"),await r(4400),l.classList.remove("show-line"),await r(500)}const ie=["local","enclosing","global","builtin"],gs=[{name:"secret",target:0},{name:"place",target:1},{name:"name",target:2},{name:"print",target:3}],ys=[{line:6,id:"local",note:"Local — this call only"},{line:3,id:"enclosing",note:"Enclosing — the function wrapped around it"},{line:0,id:"global",note:"Global — the top level of the file"},{line:7,id:"builtin",note:"print — Built-in, always there"}];function ze(s){ie.forEach(e=>{s.querySelector(`.lg-${e}`).classList.remove("is-lit","is-probing","is-found","is-empty")})}async function $s(s,e,t,o){ze(s),e.setText(t).at(1900,-1180).setScale(1),e.el.classList.remove("is-dimmed","is-answering"),e.el.classList.add("is-live","is-word"),await r(900);for(let a=0;a<=o;a+=1){const i=s.querySelector(`.lg-${ie[a]}`);i.classList.add("is-lit","is-probing"),await r(a===o?850:600),i.classList.remove("is-probing"),a===o?(i.classList.add("is-found"),s.querySelector(`.mlabel-${ie[a]}`).classList.add("is-named"),e.el.classList.add("is-answering"),await r(1700),s.querySelector(`.mlabel-${ie[a]}`).classList.remove("is-named"),e.el.classList.remove("is-answering")):(i.classList.add("is-empty"),await r(260))}await r(400)}async function fs(s){const{camera:e,tara:t,spark:o,hers:a,code:i,ui:l,root:c}=s,h=c.querySelector(".tara"),m=c.querySelector(".perch-stand");await i.clear(),m.classList.remove("is-up"),h.classList.remove("mithu-away"),c.querySelectorAll(".mlabel").forEach(u=>u.classList.remove("is-named","is-inline")),c.querySelectorAll(".lg").forEach(u=>u.classList.remove("is-lit")),await r(600),t.setPose("idle").express("happy"),await C(t.walkTo(M.centreX+620,{speed:190}),e.to({...w(M.centreX+300,-260),zoom:e.fitRoom(2200),duration:4100})),await t.face("right"),await r(600),c.querySelector(".portal").classList.add("show-shell","is-warming"),await e.to({...w(900,-620),zoom:e.fitRoom(3200),duration:3e3}),a.el.classList.add("is-settled"),o.el.classList.add("is-settled"),h.classList.add("looks-out"),t.express("happy"),await r(900),l.dataset.line="belong",l.classList.add("show-line"),await r(3400),l.classList.remove("show-line"),await e.to({...w(980,-940),zoom:e.zoomToFitWidth(1760),duration:3e3}),c.querySelector(".layer-glows").classList.add("is-live"),await r(700),l.dataset.line="fourplaces",l.classList.add("show-line"),await r(3400),l.classList.remove("show-line");for(const{name:u,target:p}of gs)await $s(c,o,u,p);ze(c),o.el.classList.remove("is-live","is-word"),await r(800),i.undock(),await i.write(['name = "Mithu"',"","def palace():",'    place = "courtyard"',"","    def room():",'        secret = "laddoo"',"        print(name, place, secret)"],{stagger:300}),await r(900),c.querySelector(".layer-glows").classList.add("is-soft");for(const{line:u,id:p,note:k}of ys)i.focus(u),i.note(u,k),c.querySelector(`.lg-${p}`).classList.add("is-lit"),c.querySelector(`.mlabel-${p}`).classList.add("is-named"),await r(2600),c.querySelector(`.mlabel-${p}`).classList.remove("is-named");i.unfocus(),await r(900),l.dataset.line="legb",l.classList.add("show-line"),await r(4600),l.classList.remove("show-line"),await r(500),l.dataset.line="assignrule",l.classList.add("show-line"),await r(4800),l.classList.remove("show-line"),await r(600),await i.clear(),c.querySelectorAll(".mlabel").forEach(u=>u.classList.add("is-fading")),c.querySelectorAll(".lg").forEach(u=>u.classList.add("is-fading")),await r(1100),c.querySelectorAll(".mlabel").forEach(u=>u.classList.remove("is-named","is-fading")),c.querySelectorAll(".lg").forEach(u=>u.classList.remove("is-lit","is-fading")),c.querySelector(".layer-glows").classList.remove("is-soft"),await e.to({...w(900,-820),zoom:e.zoomToFitWidth(1900),duration:3e3}),await r(600),l.dataset.line="bridge",l.classList.add("show-line"),await r(4200),l.classList.remove("show-line"),await r(400),l.classList.add("is-ending"),l.classList.add("show-title"),await r(4200),l.classList.add("show-sub"),await r(1600),c.querySelector(".replay").classList.add("is-offered")}async function Ls(s){const{camera:e,tara:t,spark:o,ui:a}=s;e.set({x:300,y:-1080,zoom:e.zoomToFitWidth(2e3)}),t.setPose("idle").express("neutral"),await r(400);const i=(async()=>{a.dataset.line="premise",a.classList.add("show-line"),await r(2100),a.dataset.line="premise2",await r(2100),a.dataset.line="premise3",await r(2200),a.classList.remove("show-line")})();await e.to({x:1150,y:-560,zoom:e.zoomToFitWidth(2300),duration:2300,easing:g.inOut}),await e.to({x:1600,y:420,zoom:e.zoomToFitWidth(1900),duration:2600,easing:g.inOut}),await i,await r(400),await e.to({x:n.x,y:n.y,zoom:e.zoomToFitWidth(780),duration:1800,easing:g.inOut}),s.root.querySelector(".hero-window").classList.add("is-open"),await r(2500),t.express("curious"),await t.face("right"),await r(600),await e.to({x:n.x,y:n.y,zoom:e.zoomToFitWidth(540),duration:1800,easing:g.inOut});const l=e.to({...w(0,40),zoom:e.fitRoom(1739),duration:2600,easing:g.inOut});await r(1900),s.root.querySelector(".portal").classList.add("is-inside"),s.root.querySelector(".hero-window").classList.add("is-passed"),await l,await e.to({...w(-40,90),zoom:e.fitRoom(1667),duration:1800}),await r(600),await C(t.walkTo(T.taraX-360,{speed:210}),e.to({...w(-220,110),zoom:e.fitRoom(1684),duration:2300})),await r(700),await t.face("right"),await r(500),o.el.classList.add("is-live"),await o.moveTo(360,-160,{duration:1600,easing:g.out}),t.express("curious"),await r(700),await C(o.moveTo(-60,-60,{duration:2e3,easing:g.inOut}),e.to({...w(-160,40),zoom:e.fitRoom(1481),duration:2e3})),t.setPose("reach"),await r(520),await o.moveTo(300,-240,{duration:900,easing:g.out}),t.setPose("idle"),t.express("surprised"),e.shake(5),await r(700),t.express("curious"),await C(t.walkTo(T.taraX-60,{speed:190}),e.to({...w(40,-10),zoom:e.fitRoom(1569),duration:1800})),await r(500),await o.moveTo(150,-170,{duration:1100,easing:g.inOut}),await r(400),o.el.classList.add("is-word"),e.shake(7),t.setPose("surprise"),t.express("surprised"),await r(1400),t.setPose("idle"),t.express("curious"),await r(1600),await e.to({...w(30,10),zoom:e.fitRoom(1778),duration:2e3}),a.classList.add("show-title"),await r(3400),a.classList.add("show-sub"),await r(3e3)}const xs=[Ls,rs,ls,cs,hs,us,ms,ws,ps,fs];async function vs(s){for(const e of xs)await e(s)}const bs=[{id:"local",name:"Local"},{id:"enclosing",name:"Enclosing"},{id:"global",name:"Global"},{id:"builtin",name:"Built-in"}];function ks(){return`
<nav class="journey" aria-label="Story progress">
  ...
  <ol class="journey-steps">
    ...
    <div class="stage">
      ...
      <div class="ui">
        <svg class="title-svg" viewBox="0 0 ${U.width} ${U.height}"
    ...
    </div>`;const e=s.querySelector(".world"),t=new Ze(e,U),o=s.querySelector(".tara-slot"),a=me(Ie());o.appendChild(a);const i=new Qe(a,{x:60,y:420,scale:1,facing:"left"}),l=me(ke()+Se("laddoo"),"spark-slot");o.appendChild(l);const c=new Me(l);c.at(520,-300);const h=me(ke()+Se("chameli"),"spark-slot hers");o.appendChild(h);const m=new Me(h);m.at(0,0).setScale(.06);const u=new Ne(s.querySelector(".code-air")),p=s.querySelector(".sr-live"),k=s.querySelector(".ui"),x=()=>{if(!k.classList.contains("show-line")){p.textContent="";return}const L=k.dataset.line,f=L?s.querySelector(`.narration[data-for="${L}"]`):s.querySelector('.narration[data-for="far"]'),G=f?f.textContent.trim():"";p.textContent!==G&&(p.textContent=G)};new MutationObserver(x).observe(k,{attributes:!0,attributeFilter:["class","data-line"]});const v=new Ss(s.querySelector(".journey"));v.at("local");const b={root:s,camera:t,tara:i,spark:c,hers:m,code:u,journey:v,ui:s.querySelector(".ui")},y=()=>{Oe(),s.querySelector(".hero-window").classList.remove("is-open","is-passed"),s.querySelector(".portal").classList.remove("is-inside"),l.classList.remove("is-live","is-word","is-dimmed"),h.classList.remove("is-live","is-word","is-bouncing","is-straining","is-fading"),m.at(0,0).setScale(.06),s.querySelector(".room").classList.remove("wall-felt"),s.querySelector(".room-door").classList.remove("is-noticed"),s.querySelector(".tara").classList.remove("mithu-alert"),s.querySelector(".wall-ripple").classList.remove("is-hit"),s.querySelector(".room-door").classList.remove("is-open"),s.querySelector(".portal").classList.remove("show-shell"),s.querySelector(".layer-glows").classList.remove("is-live"),s.querySelectorAll(".lg").forEach(f=>f.classList.remove("is-lit")),s.querySelectorAll(".mlabel").forEach(f=>f.classList.remove("is-named")),s.querySelector(".ask-prompt").classList.remove("is-offered","is-taken"),s.querySelector(".ask-speech").classList.remove("is-spoken"),s.querySelector(".q-motes").classList.remove("is-asking"),s.querySelector(".courtyard").classList.remove("is-hushed"),h.classList.remove("is-homebound","is-beckoning","is-inner","is-shadowing","is-touched"),l.classList.remove("is-outer","is-answering","is-shadowed","is-touched"),m.setText("chameli"),c.setText("laddoo"),s.querySelector(".reach").classList.remove("show-global","show-nonlocal","show-shadow"),s.querySelectorAll(".lg").forEach(f=>f.classList.remove("is-probing","is-empty","is-found")),s.querySelectorAll(".mlabel").forEach(f=>f.classList.remove("is-inline")),s.querySelector(".layer-glows").classList.remove("is-searching"),s.querySelector(".tara").classList.remove("has-lantern","has-megaphone","mithu-away"),h.classList.remove("is-hollow","is-claimed","is-hollow-pulse","is-clearing"),s.querySelector(".trails").classList.remove("show-out","show-local","show-blocked","is-barred"),s.querySelector(".error-spell").classList.remove("is-cast"),s.querySelector(".perch-stand").classList.remove("is-up"),s.querySelector(".shadow-tag .mlabel").classList.remove("is-named"),s.querySelector(".stage").classList.remove("is-darkened"),u.clear({duration:0}),u.undock(),s.querySelector(".tara").classList.remove("looks-out","mithu-nods"),s.querySelector(".portal").classList.remove("is-warming"),s.querySelectorAll(".is-waking").forEach(f=>f.classList.remove("is-waking")),s.querySelectorAll(".is-fading").forEach(f=>f.classList.remove("is-fading")),h.classList.remove("is-settled","is-rising","is-star"),l.classList.remove("is-settled"),s.querySelector(".layer-glows").classList.remove("is-soft"),s.querySelector(".replay").classList.remove("is-offered"),s.querySelector(".interact").innerHTML="",v.reset(),v.at("local"),Ce(),s.querySelector(".stage").classList.remove("is-paused");const L=s.querySelector(".pausebtn");L.classList.remove("is-paused"),L.setAttribute("aria-pressed","false"),L.setAttribute("aria-label","Pause the story"),b.ui.classList.remove("is-ending"),delete b.ui.dataset.line,b.ui.classList.remove("show-title","show-sub","show-line"),i.at(60,420),i.facing="left",i.apply(),c.x=520,c.y=-300,c.apply(),t.unfollow(),vs(b)},A=s.querySelector(".pausebtn"),N=s.querySelector(".stage"),j=L=>{N.classList.toggle("is-paused",L),A.classList.toggle("is-paused",L),A.setAttribute("aria-pressed",String(L)),A.setAttribute("aria-label",L?"Resume the story":"Pause the story")};return A.addEventListener("click",()=>j($e())),addEventListener("keydown",L=>{if(L.code!=="Space"&&L.key!==" ")return;const f=L.target;f instanceof Element&&(f.closest("button")||f.getAttribute("role")==="button"||f.isContentEditable)||(L.preventDefault(),j($e()))}),s.querySelector(".replay").addEventListener("click",y),R?(s.querySelector(".hero-window").classList.add("is-open","is-passed"),s.querySelector(".portal").classList.add("is-inside","show-shell"),s.querySelector(".room-door").classList.add("is-open"),h.classList.add("is-live","is-word","is-homebound"),m.at(-620,-240).setScale(1),l.classList.add("is-live","is-word"),c.at(470,-330),i.at(1760,420),i.express("confused"),s.querySelector(".layer-glows").classList.add("is-live"),s.querySelectorAll(".lg").forEach(L=>L.classList.add("is-lit")),s.querySelectorAll(".mlabel").forEach(L=>L.classList.add("is-named")),m.setText("TARA"),h.classList.add("is-inner"),m.at(-560,-300),c.setText("MITHU"),l.classList.add("is-outer"),c.at(1900,-1180),t.set({x:n.x+980*n.scale,y:n.y+-940*n.scale,zoom:t.zoomToFitWidth(1760)}),u.dock(),u.write(['name = "Mithu"',"","def room():",'    name = "Tara"',"    print(name)"],{stagger:0}),u.note(0,"Global — the palace name"),u.note(3,"assigning makes a NEW local name"),u.note(4,"finds the local one first"),b.ui.dataset.line="names",b.ui.classList.add("show-line")):y(),b}qs(document.getElementById("app"));
