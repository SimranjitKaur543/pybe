(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function t(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(a){if(a.ep)return;a.ep=!0;const i=t(a);fetch(a.href,i)}})();const D=window.matchMedia("(prefers-reduced-motion: reduce)").matches;let M=0;const B=()=>M;function rs(){return M+=1,M}const $={inOut:e=>e<.5?4*e*e*e:1-Math.pow(-2*e+2,3)/2,out:e=>1-Math.pow(1-e,3),in:e=>e*e*e,back:e=>1+2.2*Math.pow(e-1,3)+1.2*Math.pow(e-1,2)};function l(e){const s=M;return new Promise(t=>{const o=setTimeout(()=>{s===M&&t()},D?0:e);s!==M&&clearTimeout(o)})}function T({duration:e=600,easing:s=$.inOut,onUpdate:t,onDone:o}={}){let a=null,i=!1;const r=M,n=new Promise(h=>{if(D||e<=0){t?.(1),o?.(),h();return}const u=performance.now(),m=g=>{if(i)return h();if(r!==M)return;const b=Math.min(1,(g-u)/e);t?.(s(b)),b<1?a=requestAnimationFrame(m):(o?.(),h())};a=requestAnimationFrame(m)});return n.cancel=()=>{i=!0,a&&cancelAnimationFrame(a)},n}const A=(e,s,t)=>e+(s-e)*t,k=(...e)=>Promise.all(e.map(s=>typeof s=="function"?s():s));class cs{constructor(s,t){this.el=s,this.view=t,this.state={x:t.width/2,y:t.height/2,zoom:1},this.following=null,this.shakeAmount=0,this.apply(),this.tick=this.tick.bind(this),requestAnimationFrame(this.tick)}apply(){const{x:s,y:t,zoom:o}=this.state,a=this.view.width/2,i=this.view.height/2,r=this.shakeAmount?(Math.random()-.5)*this.shakeAmount:0,n=this.shakeAmount?(Math.random()-.5)*this.shakeAmount:0;this.el.setAttribute("transform",`translate(${a+r} ${i+n}) scale(${o}) translate(${-s} ${-t})`)}tick(){if(this.following&&this.following.gen!==B()&&(this.following=null),this.following){const{actor:s,offsetX:t=0,offsetY:o=0,lag:a=.08,map:i}=this.following,r=i?i(s.x,s.y):{x:s.x,y:s.y},n=r.x+t,h=r.y+o;this.state.x=A(this.state.x,n,a),this.state.y=A(this.state.y,h,a),this.apply()}else this.shakeAmount>0&&this.apply();this.shakeAmount>0&&(this.shakeAmount*=.9),this.shakeAmount<.05&&(this.shakeAmount=0),requestAnimationFrame(this.tick)}set({x:s,y:t,zoom:o}={}){return s!==void 0&&(this.state.x=s),t!==void 0&&(this.state.y=t),o!==void 0&&(this.state.zoom=o),this.apply(),this}to({x:s,y:t,zoom:o,duration:a=1400,easing:i=$.inOut}={}){const r={...this.state},n={x:s??r.x,y:t??r.y,zoom:o??r.zoom};return T({duration:a,easing:i,onUpdate:h=>{this.state.x=A(r.x,n.x,h),this.state.y=A(r.y,n.y,h),this.state.zoom=A(r.zoom,n.zoom,h),this.apply()}})}follow(s,t={}){return this.following={actor:s,...t,gen:B()},this}unfollow(){return this.following=null,this}zoomToFitWidth(s){const o=this.el.ownerSVGElement.getBoundingClientRect();if(!o.width||!o.height)return 1;const a=Math.max(o.width/this.view.width,o.height/this.view.height);return o.width/a/s}fitRoom(s,t=.225){return this.zoomToFitWidth(s*t)}shake(s=10){return this.shakeAmount=s,this}}class ns{constructor(s,{x:t=0,y:o=0,facing:a="right",scale:i=1}={}){this.el=s,this.figure=s.firstElementChild||s,this.x=t,this.y=o,this.facing=a,this.scale=i,this.pose="idle",this.apply()}apply(){const s=this.facing==="left"?-1:1;this.el.setAttribute("transform",`translate(${this.x} ${this.y}) scale(${s*this.scale} ${this.scale})`)}at(s,t){return this.x=s,t!==void 0&&(this.y=t),this.apply(),this}setPose(s){return this.figure.classList.remove(`pose-${this.pose}`),this.pose=s,this.figure.classList.add(`pose-${s}`),this}express(s){return this.figure.dataset.mood=s,this}async face(s,{duration:t=260}={}){if(this.facing===s)return;const o=s==="left"?-1:1;await T({duration:t/2,easing:$.in,onUpdate:a=>{const i=(1-a)*this.scale;this.el.setAttribute("transform",`translate(${this.x} ${this.y}) scale(${(this.facing==="left"?-1:1)*i} ${this.scale})`)}}),this.facing=s,await T({duration:t/2,easing:$.out,onUpdate:a=>{const i=a*this.scale;this.el.setAttribute("transform",`translate(${this.x} ${this.y}) scale(${o*i} ${this.scale})`)}}),this.apply()}async walkTo(s,{speed:t=300,pose:o="walk"}={}){const a=s<this.x?"left":"right";await this.face(a);const i=this.x,r=Math.abs(s-i);if(r<1)return;const n=r/t*1e3;this.setPose(o),await T({duration:n,easing:$.inOut,onUpdate:h=>{this.x=i+(s-i)*h,this.apply()}}),this.setPose("idle")}beat(s=500){return l(s)}}class ds{constructor(s){this.el=s,this.pre=s.querySelector(".ca-lines"),this.lines=[],this.texts=[]}at(){return this}dock(){return this.el.classList.add("is-docked"),this}undock(){return this.el.classList.remove("is-docked"),this}async write(s,{stagger:t=420}={}){return this.pre.innerHTML="",this.lines=[],this.texts=[],this.el.classList.add("is-open"),this.append(s,{stagger:t})}async append(s,{stagger:t=420}={}){this.el.classList.add("is-open");for(const o of s){const a=o.match(/^\s*/)[0].length,i=document.createElement("span");i.className="ca-line",i.style.paddingLeft=`${a*.62}em`,i.innerHTML=Y(o.trim())||"&nbsp;",this.pre.appendChild(i),this.lines.push(i),this.texts.push(o),requestAnimationFrame(()=>i.classList.add("is-written")),await l(t)}return this}async retype(s,t,{flash:o=!0}={}){const a=this.lines[s];if(!a)return this;const i=t.match(/^\s*/)[0].length;return a.style.paddingLeft=`${i*.62}em`,a.innerHTML=Y(t.trim())||"&nbsp;",this.texts[s]=t,o&&(a.classList.remove("is-written"),requestAnimationFrame(()=>a.classList.add("is-written")),await l(700)),this}note(s,t){const o=this.lines[s];if(!o)return this;if(o.querySelector(".ca-note")?.remove(),!t)return this;const a=document.createElement("span");return a.className="ca-note",a.textContent=`  # ${t}`,o.appendChild(a),this}clearNotes(){return this.pre.querySelectorAll(".ca-note").forEach(s=>s.remove()),this}mark(s,t){return this.lines[s]?.classList.add(t),this}unmark(s){return this.lines.forEach(t=>t.classList.remove(s)),this}focus(s){return this.lines.forEach((t,o)=>t.classList.toggle("is-running",o===s)),this}unfocus(){return this.lines.forEach(s=>s.classList.remove("is-running")),this}async clear({duration:s=700}={}){return this.el.classList.remove("is-open"),await l(s),this.pre.innerHTML="",this.lines=[],this.texts=[],this}}function Y(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const d=-246,S=46,p=-190,f=-104;function V(e,s){return`
  <g class="limb ${s}">
    <path class="churidar" d="M ${e-13} ${f}
      C ${e-15} ${f+46} ${e-13} -40 ${e-11} -12
      L ${e+11} -12
      C ${e+13} -40 ${e+15} ${f+46} ${e+13} ${f} Z" />
    <path class="cuff" d="M ${e-12} -26 L ${e+12} -26 L ${e+11} -14 L ${e-11} -14 Z" />
    <ellipse class="slipper" cx="${e+3}" cy="-5" rx="19" ry="9" />
  </g>`}function K(e,s,t=""){return`
  <g class="limb ${s}">
...
<g class="tara pose-idle" data-mood="neutral">
  ...
  <g class="body">
    <path class="kurta" d="M -32 ${p-6}
      C -48 ${p+22} -50 ${f-20} -54 ${f+16}
      L 54 ${f+16}
      C 50 ${f-20} 44 ${p+22} 32 ${p-6}
      C 18 ${p-18} -18 ${p-18} -32 ${p-6} Z" />
    <path class="kurta-hem" d="M -54 ${f+4} L 54 ${f+4} L 54 ${f+16} L -54 ${f+16} Z" />
    <path class="dupatta" d="M -30 ${p-2}
      C -6 ${p+26} 22 ${p+22} 34 ${p+2}
      C 44 ${p+54} 38 ${f+6} 26 ${f+30}
      L 8 ${f+24}
      C 22 ${f-6} 28 ${p+58} 20 ${p+34}
      C 4 ${p+46} -18 ${p+40} -30 ${p+22} Z" />
  </g>

  <!-- near side limbs -->
  ${V(17,"leg-near")}
  ${K(48,"arm-near",hs(40,p+104)+us(40,p+96))}
  ...
  <g class="head">
    <circle class="hair" cx="-2" cy="${d-6}" r="${S+5}" />
    <circle class="skin" cx="3" cy="${d+4}" r="${S}" />
    <path class="hair" d="M ${-S+2} ${d-6}
      C ${-S+4} ${d-34} ${S-6} ${d-40} ${S+1} ${d-12}
      C ${S-12} ${d-26} 4 ${d-30} -10 ${d-16}
      C -22 ${d-6} ${-S+6} ${d+2} ${-S+2} ${d-6} Z" />
...
<g class="mithu">
...
</g>`}function Q(e,s,t,o,a="stone"){const i=t/2;return`<g class="${a}">
    <path d="M ${e-i} ${s}
  ...
  </g>`}function X(e,s,t,o){const a=t/2,i=e+a;return`M ${e} ${s+o}
          L ${e} ${s+a*.72}
          Q ${e} ${s} ${i} ${s-a*.28}
          Q ${e+t} ${s} ${e+t} ${s+a*.72}
          L ${e+t} ${s+o} Z`}function I(e,s,t,o,a="arch"){return`<path class="${a}" d="${X(e,s,t,o)}" />`}function W(e,s,t,o,a=0){return`<path class="lit-window" style="animation-delay:${a}s" d="${X(e,s,t,o)}" />`}function Z(e,s,t,o,a,i,r="arch"){const n=r==="lit"?W:I;return Array.from({length:t},(h,u)=>r==="lit"?n(e+u*(o+i),s,o,a,u*.83%5):n(e+u*(o+i),s,o,a)).join("")}function G(e,s,t,o=30){const a=o/2;return`<g class="stone">
  ...
  </g>`}function O(e,s,t,o){const a=t/2;return`<g class="stone">
    <rect x="${e-a}" y="${s-7}" width="${t}" height="8" rx="4" />
    <rect x="${e-a+5}" y="${s-o}" width="6" height="${o-7}" />
    <rect x="${e+a-11}" y="${s-o}" width="6" height="${o-7}" />
  </g>${Q(e,s-o,t*.9,o*.7)}`}function _(e=0,s=18,t={x:0,y:0,w:1600,h:900}){let o=e*9301+49297;const a=()=>(o=(o*9301+49297)%233280)/233280;return`<g class="motes">${Array.from({length:s},()=>{const i=t.x+a()*t.w,r=t.y+a()*t.h,n=2+a()*2.6,h=(a()*9).toFixed(2),u=(7+a()*7).toFixed(2);return`<circle cx="${i}" cy="${r}" r="${n}" style="animation-delay:${h}s; animation-duration:${u}s" />`}).join("")}</g>`}function J(e,s,t,o,a=2.6){const i=e+t/2;return`<path class="light-shaft" d="M ${e} ${s} L ${e+t} ${s}
    L ${i+t*a/2} ${s+o} L ${i-t*a/2} ${s+o} Z" />`}function ms(){return`
<defs>
...
</defs>`}const x={floorY:420,taraX:60,wallX:-1090,doorX:390};function gs(){const{floorY:e}=x;return`
<g class="room">
  <!-- back wall and floor -->
...
</g>`}const L={x0:560,x1:3180,floorY:x.floorY,centreX:1840,askX:1760};function $s(e,s){return`
<g class="fountain">
...
</g>`}function ps(){const{x0:e,x1:s,floorY:t,centreX:o}=L,a=-760;return`
<g class="courtyard">
  ...
  <g class="balconies">
    ${[900,1500,2100,2700].map((i,r)=>`
      <g class="balcony">
        ...
        <path class="balcony-arch" d="${X(i-96,a+60,192,178)}" />
  ...
  <g class="court-arcade">
    ${[760,1180,2500,2920].map(i=>`
      <path class="court-niche" d="${X(i-110,t-430,220,430)}" />`).join("")}
    ${G(970,t-470,t,46)}
    ${G(2710,t-470,t,46)}
  </g>

  <!-- moonlight falling into the open court -->
  ${J(1420,a+40,300,t-a-40,1.9)}
  ${J(2260,a+40,240,t-a-40,1.7)}
  ...
  <g class="court-tiles">
    ${Array.from({length:13},(i,r)=>`<rect x="${e+r*200}" y="${t}" width="5" height="560" />`).join("")}
    ${Array.from({length:4},(i,r)=>`<rect x="${e}" y="${t+90+r*120}" width="${s-e}" height="5" />`).join("")}
  </g>
...
</g>`}const P={x0:-1560,x1:3520,roofY:-1320,baseY:1010};function Ls(){return`
<g class="kingdom">
  ...
  <path class="kd-hills far" d="M -6000 980 Q -3000 600 -600 940 Q 1800 1240 4400 860 Q 7400 520 10000 960
    L 10000 3400 L -6000 3400 Z" />
</g>`}function vs(){const{x0:e,x1:s,roofY:t,baseY:o}=P;return`
<g class="shell">
...
</g>`}function bs(){const e={x0:-1200,x1:540,y0:-640,y1:x.floorY+120},s={x0:L.x0-20,x1:L.x1+20,y0:-800,y1:L.floorY+200},t={x0:P.x0-80,x1:P.x1+80,y0:P.roofY-160,y1:P.baseY+90};return`
<g class="layer-glows">
  <!-- 1 · her room -->
  <g class="lg lg-local">
  ...
  <g class="lg lg-enclosing">
    ...
    <path class="lg-link" d="M ${e.x1} ${x.floorY-200} L ${s.x0} ${x.floorY-200}" />
  </g>
...
<g class="trails">
...
</g>`}const c={x:1600,y:300,w:380,h:520,scale:.225},q=980,ss=(()=>{let e=12345;const s=()=>(e=(e*9301+49297)%233280)/233280;return Array.from({length:44},()=>({x:-1400+s()*5e3,y:-1500+s()*1900,r:1.6+s()*3.4,d:(s()*6).toFixed(2),layer:s()<.4?"far":"near"}))})();function F(e,s,t,o,a){return`<g class="cloud" style="animation-delay:${o}s; animation-duration:${a}s"
  ...
  </g>`}function j(e,s,t,o){return`<g class="flagpole-g">
...
<g class="palace">
  <!-- outer wings -->
  <rect class="stone" x="880" y="700" width="200" height="${q-700}" rx="6" />
  ${O(980,700,74,58)}
  <rect class="stone" x="2120" y="700" width="200" height="${q-700}" rx="6" />
  ${O(2220,700,74,58)}
  ${Z(906,800,2,56,150,44,"lit")}
  ${Z(2146,800,2,56,150,44,"lit")}

  <!-- flanking towers -->
  <rect class="stone" x="1120" y="420" width="112" height="${q-420}" rx="6" />
  ${Q(1176,420,132,108)}
  <rect class="stone" x="1968" y="420" width="112" height="${q-420}" rx="6" />
  ${Q(2024,420,132,108)}
  ${j(1176,306,62,0)}
  ${j(2024,306,62,1.3)}

  <!-- great hall -->
  <rect class="stone" x="1220" y="520" width="760" height="${q-520}" rx="8" />
  ...
  ${Z(1254,700,2,58,160,52,"lit")}
  ${Z(1830,700,2,58,160,52,"lit")}
  ${W(1148,560,48,120,2.1)}
  ${W(1996,560,48,120,.8)}
  ${W(1560,180,74,130,1.6)}

  <!-- plinth -->
  <rect class="plinth" x="820" y="${q-28}" width="1560" height="40" rx="8" />
</g>

<rect class="ground" x="-2600" y="${q}" width="8000" height="900" />
  ...
  <g class="portal" clip-path="url(#heroClip)">
    <g transform="translate(${c.x} ${c.y}) scale(${c.scale})">
      ...
      <g class="magic-labels">
        ${z("local","Local",-330,-900)}
        ${z("enclosing","Enclosing",1870,-1120,"because her room sits inside it")}
        ${z("global","Global",980,-1760)}
        ${z("builtin","Built-in",980,-2520)}
      </g>
      ${qs()}
      ${ks()}
      ${Ss()}
...
${_(3,14,{x:700,y:200,w:1800,h:800})}`}function Ms(){return`<clipPath id="heroClip">
...
</g>`}function ts(e){const s=Math.max(190,e.length*30+84);return`
...
</g>`}function As(e=26){let s=777;const t=()=>(s=(s*9301+49297)%233280)/233280;return`<g class="title-motes">${Array.from({length:e},()=>{const o=t()*Math.PI*2,a=300+t()*620;return`<circle r="${2+t()*3.2}"
      style="--fx:${(Math.cos(o)*a).toFixed(1)}px; --fy:${(Math.sin(o)*a*.6).toFixed(1)}px;
             animation-delay:${(t()*1.1).toFixed(2)}s" />`}).join("")}</g>`}const w=(e,s)=>({x:c.x+e*c.scale,y:c.y+s*c.scale}),v=1/c.scale,as={x:26,y:176},C=x.wallX;async function zs(e){const{camera:s,tara:t,spark:o,hers:a,ui:i,root:r}=e,n=r.querySelector(".room"),h=r.querySelector(".wall-ripple");i.classList.contains("show-title")&&(i.classList.add("title-out"),await l(1200),i.classList.remove("show-title","show-sub","title-out")),o.moveTo(470,-330,{duration:2100,easing:$.inOut}),r.querySelector(".spark-slot").classList.add("is-dimmed"),await s.to({...w(t.x-30,150),zoom:v*1.02,duration:2e3}),t.express("curious"),await l(700),await s.to({...w(t.x+10,70),zoom:v*1.5,duration:2e3}),await l(500),t.setPose("whisper"),await l(700),a.at(t.x+as.x,t.y-as.y).setScale(.06),a.el.classList.add("is-live"),await l(300),await a.scaleTo(1,{duration:1e3,easing:$.back}),a.el.classList.add("is-word"),await l(600),t.setPose("idle"),t.express("happy"),await k(a.moveTo(t.x+120,t.y-330,{duration:2e3,easing:$.out}),s.to({...w(t.x+60,-60),zoom:v*1.18,duration:2e3})),await l(500),t.express("curious"),s.follow(a,{map:(u,m)=>w(u,m),offsetY:60,lag:.035}),await a.moveTo(-180,-400,{duration:2e3,easing:$.inOut}),await a.moveTo(-430,-250,{duration:2e3,easing:$.inOut}),await k(t.walkTo(-320,{speed:200}),a.moveTo(-700,-320,{duration:2e3,easing:$.inOut})),await a.moveTo(C,-300,{duration:1800,easing:$.in}),h.setAttribute("transform",`translate(${C-20} -300)`),h.classList.remove("is-hit"),h.getBoundingClientRect(),h.classList.add("is-hit"),a.el.classList.add("is-bouncing"),s.shake(9),await a.moveTo(C+250,-350,{duration:700,easing:$.out}),a.el.classList.remove("is-bouncing"),s.unfollow(),await s.to({...w(-520,-190),zoom:v*1.1,duration:1200}),t.express("surprised"),await l(700),t.express("curious"),s.follow(a,{map:(u,m)=>w(u,m),offsetY:40,lag:.03}),await a.moveTo(C+30,-270,{duration:2e3,easing:$.inOut}),h.classList.remove("is-hit"),h.getBoundingClientRect(),h.setAttribute("transform",`translate(${C-10} -270)`),h.classList.add("is-hit"),a.el.classList.add("is-straining"),s.shake(5),await l(900),a.el.classList.add("is-fading"),await l(1300),a.el.classList.remove("is-live","is-word","is-straining","is-fading"),s.unfollow(),await s.to({...w(-560,-60),zoom:v*1.16,duration:1800}),t.express("confused"),await l(800),await t.walkTo(-760,{speed:150}),await t.face("left"),t.setPose("touch"),n.classList.add("wall-felt"),await l(1400),r.querySelector(".tara").classList.add("mithu-alert"),await l(1e3),t.setPose("idle"),await t.face("right"),t.express("curious"),await s.to({...w(-420,-40),zoom:v*.84,duration:2e3}),await l(500),r.querySelector(".room-door").classList.add("is-noticed"),await l(1100),i.classList.add("show-line"),await l(4e3),i.classList.remove("show-line"),n.classList.remove("wall-felt"),r.querySelector(".tara").classList.remove("mithu-alert"),r.querySelector(".room-door").classList.remove("is-noticed"),await l(400)}async function Cs(e){const{camera:s,tara:t,hers:o,ui:a,root:i}=e,r=i.querySelector(".room-door"),n=i.querySelector(".ask-prompt"),h=i.querySelector(".ask-speech"),u=i.querySelector(".q-motes");o.at(-620,-240).setScale(1),o.el.classList.add("is-live","is-word","is-homebound"),await l(500),i.querySelector(".tara").classList.add("mithu-alert"),await l(700),t.express("curious"),await t.face("right"),await l(400),r.classList.add("is-open"),await l(600),s.follow(t,{map:(m,g)=>w(m,g),offsetY:-150,lag:.028}),await t.walkTo(x.doorX+40,{speed:210}),await l(500),await t.walkTo(L.x0+300,{speed:200}),s.unfollow(),await s.to({...w(L.centreX-260,-120),zoom:v*.52,duration:2900,easing:$.inOut}),t.express("surprised"),await l(600),await t.face("left"),await l(400),await t.face("right"),t.express("curious"),await l(500),n.setAttribute("transform",`translate(${L.centreX+40} -520)`),n.classList.add("is-offered"),await new Promise(m=>{const g=()=>{n.removeEventListener("click",g),n.removeEventListener("keydown",b),m()},b=y=>{(y.key==="Enter"||y.key===" ")&&(y.preventDefault(),g())};n.addEventListener("click",g),n.addEventListener("keydown",b)}),n.classList.remove("is-offered"),n.classList.add("is-taken"),await k(t.walkTo(L.askX,{speed:190}),s.to({...w(L.askX+60,-180),zoom:v*.6,duration:2100})),await l(300),await t.face("left"),await l(300),t.setPose("reach"),t.express("curious"),h.setAttribute("transform",`translate(${L.askX+30} -330)`),h.classList.add("is-spoken"),await l(1400),t.setPose("idle"),h.classList.remove("is-spoken"),u.setAttribute("transform",`translate(${L.askX+40} -420)`),u.classList.add("is-asking"),i.querySelector(".courtyard").classList.add("is-hushed"),await l(1400),u.classList.remove("is-asking"),t.express("confused"),i.querySelector(".tara").classList.add("mithu-alert"),await l(900),await t.face("left"),await l(300),await s.to({...w(700,-180),zoom:v*.34,duration:2900,easing:$.inOut}),o.el.classList.add("is-beckoning"),await l(1400),a.dataset.line="born",a.classList.add("show-line"),await l(4800),a.classList.remove("show-line"),await l(500),i.querySelector(".tara").classList.remove("mithu-alert"),i.querySelector(".courtyard").classList.remove("is-hushed"),o.el.classList.remove("is-beckoning")}const Es=[{id:"local",cls:"lg-local"},{id:"enclosing",cls:"lg-enclosing"},{id:"global",cls:"lg-global"},{id:"builtin",cls:"lg-builtin"}];async function Ps(e){const{camera:s,tara:t,code:o,ui:a,root:i}=e,r=i.querySelector(".layer-glows"),n=i.querySelector(".magic-labels");t.setPose("idle").express("curious"),await s.to({...w(900,-420),zoom:s.zoomToFitWidth(1080),duration:2900,easing:$.inOut}),await l(400),i.querySelector(".portal").classList.add("show-shell"),await s.to({...w(980,-940),zoom:s.zoomToFitWidth(1760),duration:3200,easing:$.inOut}),await l(600),r.classList.add("is-live");for(const h of Es)i.querySelector(`.${h.cls}`).classList.add("is-lit"),await l(500),n.querySelector(`.mlabel-${h.id}`).classList.add("is-named"),await l(1200);await l(700),a.dataset.line="names",a.classList.add("show-line"),await l(3600),a.classList.remove("show-line"),a.dataset.line="legb",a.classList.add("show-line"),await l(4600),a.classList.remove("show-line"),o.dock(),await o.write(['name = "Mithu"'],{stagger:0}),o.note(0,"Global — out in the open palace"),await l(2100)}const Zs=[{cls:"lg-local",found:!1,note:"not in room() — look outward"},{cls:"lg-enclosing",found:!1,note:"not in the enclosing space either"},{cls:"lg-global",found:!0,note:"found it — the palace name"}];async function Os(e){const{camera:s,tara:t,spark:o,hers:a,code:i,ui:r,root:n}=e,h=n.querySelector(".layer-glows"),u=n.querySelector(".tara");n.querySelectorAll(".mlabel").forEach(m=>m.classList.remove("is-named")),n.querySelectorAll(".lg").forEach(m=>m.classList.remove("is-lit")),o.setText("MITHU").at(1900,-1180).setScale(1),o.el.classList.remove("is-dimmed"),o.el.classList.add("is-live","is-word","is-outer"),await s.to({...w(760,-560),zoom:s.zoomToFitWidth(1180),duration:2100}),t.express("curious"),await l(600),u.classList.add("mithu-alert"),r.dataset.line="wider",r.classList.add("show-line"),await l(3400),r.classList.remove("show-line"),u.classList.remove("mithu-alert"),i.clearNotes(),await i.append(["","def room():","    print(name)"],{stagger:380}),i.focus(3),await l(700),u.classList.add("has-lantern"),await l(600),h.classList.add("is-live","is-searching");for(const m of Zs){const g=n.querySelector(`.${m.cls}`);g.classList.add("is-lit","is-probing"),i.note(3,m.note),m.cls==="lg-enclosing"&&k(t.walkTo(L.centreX-200,{speed:230}),s.to({...w(900,-640),zoom:s.zoomToFitWidth(1420),duration:2200})),m.cls==="lg-global"&&s.to({...w(980,-860),zoom:s.zoomToFitWidth(1780),duration:2400}),await l(1400),m.found?(g.classList.remove("is-probing"),g.classList.add("is-found"),o.el.classList.add("is-answering"),i.mark(3,"is-ok"),t.express("happy"),s.shake(5),await l(1800)):(g.classList.remove("is-probing"),g.classList.add("is-empty"),await l(300))}await l(1e3),i.unmark("is-ok"),i.note(3,"and print? found in the outermost ring"),n.querySelector(".lg-builtin").classList.add("is-lit","is-found"),n.querySelector(".mlabel-builtin").classList.add("is-named"),await l(1300),r.dataset.line="builtin",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),n.querySelector(".mlabel-builtin").classList.remove("is-named"),n.querySelectorAll(".lg").forEach(m=>m.classList.remove("is-empty","is-found")),h.classList.remove("is-searching"),o.el.classList.remove("is-answering"),i.unfocus(),i.clearNotes()}const H={x:-560,y:-300};async function Rs(e){const{camera:s,tara:t,spark:o,hers:a,code:i,ui:r,root:n}=e,h=n.querySelector(".tara");await k(t.walkTo(x.taraX-120,{speed:240}),s.to({...w(-120,-240),zoom:s.zoomToFitWidth(760),duration:2800})),h.classList.remove("has-lantern"),await t.face("right"),t.express("curious"),await l(700),t.setPose("whisper"),await l(600),a.setText("MITHU").at(H.x,H.y).setScale(.05),a.el.classList.remove("is-homebound","is-beckoning"),a.el.classList.add("is-live","is-inner"),await a.scaleTo(1,{duration:1e3,easing:$.back}),a.el.classList.add("is-word"),t.setPose("idle"),await i.retype(3,'    name = "Tara"'),i.mark(3,"is-claim"),i.note(3,"assigning MAKES a new local name"),await i.append(["    print(name)"],{stagger:0}),await l(1300),await s.to({...w(560,-620),zoom:s.zoomToFitWidth(1500),duration:2200}),await l(1e3),await s.to({...w(-260,-260),zoom:s.zoomToFitWidth(820),duration:2e3}),await t.walkTo(H.x+250,{speed:200}),await t.face("left"),t.setPose("reach"),await l(400),a.el.classList.add("is-touched"),s.shake(4),await a.morphTo("TARA",{duration:1100}),a.el.classList.remove("is-touched"),t.setPose("idle"),t.express("surprised"),await l(700),await s.to({...w(620,-640),zoom:s.zoomToFitWidth(1560),duration:2200}),o.el.classList.add("is-answering"),i.note(0,"untouched"),await l(1400),o.el.classList.remove("is-answering"),i.note(0,""),t.express("happy"),h.classList.add("mithu-alert"),await l(1e3),h.classList.remove("mithu-alert");const u=n.querySelector(".mlabel-local");u.classList.add("is-named","is-inline"),await l(2200),i.unmark("is-claim"),i.focus(3),await l(900),r.dataset.line="readassign",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),i.unfocus(),await s.to({...w(-160,-420),zoom:s.zoomToFitWidth(1120),duration:2200}),await l(500),n.querySelector(".reach").classList.add("show-shadow"),o.el.classList.add("is-shadowed"),a.el.classList.add("is-shadowing"),i.focus(4),i.note(4,"finds the local one; outer is hidden"),await l(1800),r.dataset.line="hides",r.classList.add("show-line"),await l(4200),r.classList.remove("show-line"),await l(700),i.unfocus(),i.clearNotes(),u.classList.remove("is-inline")}async function Fs(e){const{camera:s,tara:t,spark:o,hers:a,code:i,ui:r,root:n}=e,h=n.querySelector(".tara"),u=n.querySelector(".reach");u.classList.remove("show-shadow"),o.el.classList.remove("is-shadowed"),a.el.classList.remove("is-shadowing"),await l(500),await s.to({...w(400,-620),zoom:s.zoomToFitWidth(1420),duration:2200}),await t.face("right"),t.express("curious"),await l(900),h.classList.add("mithu-alert"),r.dataset.line="speak",r.classList.add("show-line"),await l(3600),r.classList.remove("show-line"),h.classList.remove("mithu-alert"),await s.to({...w(-200,-300),zoom:s.zoomToFitWidth(880),duration:2e3}),h.classList.add("has-megaphone"),await l(600),t.setPose("reach"),t.express("happy"),await l(600),await s.to({...w(700,-700),zoom:s.zoomToFitWidth(1620),duration:2100}),await i.retype(3,"    global name"),i.mark(3,"is-claim"),i.note(3,"rebinds the palace name, not a local one"),await i.append(['    name = "Tara"'],{stagger:0}),await l(1e3),u.classList.add("show-global"),s.shake(6),await l(1500),o.el.classList.add("is-touched"),await o.morphTo("TARA",{duration:1200}),o.el.classList.remove("is-touched"),o.el.classList.add("is-answering"),s.shake(8),await l(1400),t.setPose("idle"),o.el.classList.remove("is-answering"),u.classList.remove("show-global"),h.classList.remove("has-megaphone"),await l(600);const m=n.querySelector(".mlabel-global");m.classList.add("is-named","is-inline"),await l(2200),m.classList.remove("is-inline","is-named"),await s.to({...w(260,-420),zoom:s.zoomToFitWidth(1240),duration:2100}),h.classList.add("mithu-alert"),i.unmark("is-claim"),i.clearNotes(),await i.write(["def palace():",'    name = "Mithu"',"","    def room():","        nonlocal name",'        name = "Tara"'],{stagger:300}),i.focus(4),i.note(4,"reaches the ENCLOSING room only"),u.classList.add("show-nonlocal"),await l(1400),r.dataset.line="nonlocal",r.classList.add("show-line"),await l(4600),r.classList.remove("show-line"),u.classList.remove("show-nonlocal"),h.classList.remove("mithu-alert"),i.unfocus(),i.clearNotes(),t.express("happy"),await l(900)}async function Qs(e){const{camera:s,tara:t,spark:o,hers:a,code:i,ui:r,root:n}=e,h=n.querySelector(".tara"),u=n.querySelector(".trails"),m=n.querySelector(".error-spell");o.setText("MITHU").at(1900,-1180),o.el.classList.add("is-live","is-word","is-outer"),o.el.classList.remove("is-shadowed"),a.el.classList.remove("is-word","is-live","is-inner","is-shadowing","is-hollow"),await s.to({...w(40,-140),zoom:s.fitRoom(1500),duration:2500}),await t.face("right"),t.express("curious"),await i.write(['name = "Mithu"',"","def room():","    print(name)",'    name = "Tara"'],{stagger:300}),await l(700),u.classList.add("show-out"),o.el.classList.add("is-answering"),await l(1500),u.classList.remove("show-out"),o.el.classList.remove("is-answering"),await l(500),await s.to({...w(-380,-200),zoom:s.fitRoom(1e3),duration:2e3}),await t.face("left"),t.setPose("reach"),await l(500),a.setText("name").at(-560,-300).setScale(.1),a.el.classList.add("is-live","is-hollow"),await a.scaleTo(1,{duration:900,easing:$.back}),a.el.classList.add("is-word"),s.shake(4),t.setPose("idle"),await l(900),a.el.classList.add("is-claimed"),i.focus(4),i.note(4,"seen first — so name is local everywhere"),await l(1900),t.setPose("reach"),t.express("curious"),u.classList.add("show-local"),i.focus(3),i.note(3,"runs first — local name still empty"),await l(1300),a.el.classList.add("is-hollow-pulse"),await l(1e3),u.classList.remove("show-local"),await s.to({...w(140,-300),zoom:s.fitRoom(1700),duration:2e3}),u.classList.add("show-blocked"),await l(700),u.classList.add("is-barred"),s.shake(9),t.setPose("surprise"),t.express("surprised"),h.classList.add("mithu-alert"),await l(1100),u.classList.remove("show-blocked","is-barred"),n.querySelector(".stage").classList.add("is-darkened"),m.setAttribute("transform","translate(120 -700)"),m.classList.add("is-cast"),i.mark(3,"is-error"),i.focus(3),s.shake(12),await l(1800),r.dataset.line="claimed",r.classList.add("show-line"),await l(4200),r.classList.remove("show-line"),await l(400),r.dataset.line="lookedthere",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),await l(1e3),m.classList.remove("is-cast"),n.querySelector(".stage").classList.remove("is-darkened"),h.classList.remove("mithu-alert"),t.setPose("idle"),a.el.classList.remove("is-hollow-pulse"),i.unmark("is-error"),i.unfocus(),i.clearNotes(),await l(600)}const is={x:620,y:-1180};async function Ws(e){const{camera:s,tara:t,spark:o,hers:a,code:i,ui:r,root:n}=e,h=n.querySelector(".tara"),u=n.querySelector(".trails"),m=n.querySelector(".perch-stand"),g=n.querySelector(".error-spell");await k(t.walkTo(x.taraX-220,{speed:200}),s.to({...w(-120,-260),zoom:s.fitRoom(1300),duration:2400})),await t.face("right"),t.setPose("sit"),t.express("curious"),m.setAttribute("transform",`translate(${x.taraX+190} ${x.floorY})`),m.classList.add("is-up"),h.classList.add("mithu-away"),await l(600),r.dataset.line="rules",r.classList.add("show-line"),await l(3800),r.classList.remove("show-line"),i.at(is.x,is.y),i.undock(),await i.clear({duration:400}),await s.to({...w(520,-760),zoom:s.fitRoom(2100),duration:2200}),a.el.classList.remove("is-word","is-live","is-hollow","is-claimed","is-hollow-pulse","is-inner","is-shadowing","is-clearing"),o.setText("MITHU").at(1900,-1180),o.el.classList.add("is-live","is-word","is-outer"),await i.write(['name = "Mithu"',"","def room():","    print(name)"]),await l(300),i.focus(3),u.classList.add("show-out"),await l(600),o.el.classList.add("is-answering"),await l(900),r.dataset.line="lookout",r.classList.add("show-line"),await l(3900),r.classList.remove("show-line"),u.classList.remove("show-out"),o.el.classList.remove("is-answering"),i.unfocus(),await i.clear(),await i.write(['name = "Mithu"',"","def room():",'    name = "Tara"',"    print(name)"]),await l(300),i.focus(3),a.setText("TARA").at(-560,-300).setScale(.1),a.el.classList.remove("is-hollow","is-claimed"),a.el.classList.add("is-live","is-inner"),await a.scaleTo(1,{duration:900,easing:$.back}),a.el.classList.add("is-word"),await l(500),i.focus(4),u.classList.add("show-local"),a.el.classList.add("is-shadowing"),o.el.classList.add("is-shadowed"),await l(1100),r.dataset.line="hides",r.classList.add("show-line"),await l(3800),r.classList.remove("show-line");const b=n.querySelector(".shadow-tag .mlabel");b.classList.add("is-named"),await l(1400),b.classList.remove("is-named"),u.classList.remove("show-local"),o.el.classList.remove("is-shadowed"),a.el.classList.remove("is-shadowing"),i.unfocus(),await i.clear(),await i.write(['name = "Mithu"',"","def room():","    print(name)",'    name = "Tara"']),await l(400),i.focus(4),await l(600),a.setText("name").at(-560,-300).setScale(.1),a.el.classList.remove("is-inner"),a.el.classList.add("is-live","is-hollow"),await a.scaleTo(1,{duration:800,easing:$.back}),a.el.classList.add("is-word","is-claimed"),s.shake(4),await l(900),i.focus(3),u.classList.add("show-blocked"),a.el.classList.add("is-hollow-pulse"),await l(700),u.classList.add("is-barred"),s.shake(8),await l(600),u.classList.remove("show-blocked","is-barred"),g.setAttribute("transform","translate(620 -320)"),n.querySelector(".stage").classList.add("is-darkened"),g.classList.add("is-cast"),i.mark(3,"is-error"),await l(1200),r.dataset.line="assigns",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),await l(300),r.dataset.line="novalue",r.classList.add("show-line"),await l(4e3),r.classList.remove("show-line"),g.classList.remove("is-cast"),n.querySelector(".stage").classList.remove("is-darkened"),i.unfocus(),i.unmark("is-error"),await i.clear(),a.el.classList.remove("is-hollow-pulse"),await i.write(["len = 5",'print(len("palace"))'],{stagger:380}),await l(400),i.focus(0),i.note(0,"this hides the built-in len"),n.querySelector(".lg-builtin").classList.add("is-lit"),n.querySelector(".mlabel-builtin").classList.add("is-named"),await l(1200),i.focus(1),i.mark(1,"is-error"),i.note(1,"TypeError — 5 is not a function"),s.shake(6),t.express("surprised"),await l(1400),r.dataset.line="shadowbuiltin",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),n.querySelector(".mlabel-builtin").classList.remove("is-named"),n.querySelector(".lg-builtin").classList.remove("is-lit"),i.unfocus(),i.unmark("is-error"),i.clearNotes(),await i.clear(),t.express("curious"),await s.to({...w(-140,-180),zoom:s.fitRoom(1500),duration:2e3}),t.setPose("idle");for(let y=0;y<2;y+=1)await t.walkTo(x.taraX-160,{speed:240}),a.setText("TARA").at(-560,-300).setScale(.1),a.el.classList.remove("is-hollow","is-claimed"),a.el.classList.add("is-live","is-inner"),await a.scaleTo(1,{duration:700,easing:$.back}),a.el.classList.add("is-word"),await l(600),await t.walkTo(x.doorX+60,{speed:240}),a.el.classList.add("is-clearing"),await l(500),a.el.classList.remove("is-live","is-word","is-clearing","is-inner"),await l(400);r.dataset.line="freshcall",r.classList.add("show-line"),await l(4e3),r.classList.remove("show-line"),await t.walkTo(x.taraX-160,{speed:220}),await t.face("right"),t.express("happy"),await s.to({...w(980,-940),zoom:s.zoomToFitWidth(1760),duration:3e3}),n.querySelector(".layer-glows").classList.add("is-live");for(const y of["local","enclosing","global","builtin"])n.querySelector(`.lg-${y}`).classList.add("is-lit"),await l(300);await l(600),r.dataset.line="begins",r.classList.add("show-line"),await l(4400),r.classList.remove("show-line"),await l(600)}const Xs=["local","enclosing","global","builtin"];async function Gs(e){const{camera:s,tara:t,spark:o,hers:a,code:i,ui:r,root:n}=e,h=n.querySelector(".tara"),u=n.querySelector(".perch-stand");await i.clear(),u.classList.remove("is-up"),h.classList.remove("mithu-away"),n.querySelectorAll(".mlabel").forEach(g=>g.classList.remove("is-named","is-inline")),n.querySelectorAll(".lg").forEach(g=>g.classList.remove("is-lit")),await l(600),t.setPose("idle").express("happy"),await k(t.walkTo(L.centreX+620,{speed:190}),s.to({...w(L.centreX+300,-260),zoom:s.fitRoom(2200),duration:4100})),await t.face("right"),await l(600),n.querySelector(".portal").classList.add("show-shell"),await s.to({...w(900,-620),zoom:s.fitRoom(3600),duration:3600});const m=[...n.querySelectorAll(".shell-lit, .courtyard .lantern-glow, .room-window ~ * .lit-window")];n.querySelector(".portal").classList.add("is-warming");for(const g of m.slice(0,10))g.classList.add("is-waking"),await l(300);await l(700),a.el.classList.add("is-settled"),o.el.classList.add("is-settled"),await s.to({...w(980,-940),zoom:s.zoomToFitWidth(1760),duration:3e3}),await l(800),await s.to({...w(L.centreX+640,-180),zoom:s.fitRoom(1100),duration:3600,easing:$.inOut}),h.classList.add("looks-out"),t.express("happy"),await l(700),r.dataset.line="whenever",r.classList.add("show-line"),await l(1900),r.classList.remove("show-line"),await t.face("left"),await l(400),await t.face("right"),await l(300),r.dataset.line="belong",r.classList.add("show-line"),await l(3800),r.classList.remove("show-line"),h.classList.add("mithu-nods"),await l(900),h.classList.remove("mithu-nods"),r.dataset.line="whichscope",r.classList.add("show-line"),await l(3600),r.classList.remove("show-line"),await s.to({...w(980,-940),zoom:s.zoomToFitWidth(1760),duration:3e3}),n.querySelector(".layer-glows").classList.add("is-live","is-soft");for(const g of Xs)n.querySelector(`.lg-${g}`).classList.add("is-lit"),n.querySelector(`.mlabel-${g}`).classList.add("is-named"),await l(400);await l(1200),n.querySelectorAll(".mlabel").forEach(g=>g.classList.add("is-fading")),n.querySelectorAll(".lg").forEach(g=>g.classList.add("is-fading")),await l(1100),n.querySelectorAll(".mlabel").forEach(g=>g.classList.remove("is-named","is-fading")),n.querySelectorAll(".lg").forEach(g=>g.classList.remove("is-lit","is-fading")),n.querySelector(".layer-glows").classList.remove("is-soft"),a.el.classList.remove("is-settled"),await s.to({...w(-300,-500),zoom:s.fitRoom(1600),duration:2400}),await l(400),a.el.classList.add("is-rising"),await k(a.moveTo(-200,-3200,{duration:4100,easing:$.inOut}),a.scaleTo(.08,{duration:4100,easing:$.in}),s.to({...w(-160,-2400),zoom:s.fitRoom(2600),duration:4100})),a.el.classList.add("is-star"),await l(1e3),await s.to({...w(900,-820),zoom:s.zoomToFitWidth(1900),duration:3600}),await l(600),r.dataset.line="beginssearch",r.classList.add("show-line"),await l(4200),r.classList.remove("show-line"),await l(400),r.dataset.line="bridge",r.classList.add("show-line"),await l(4200),r.classList.remove("show-line"),await l(400),r.classList.add("is-ending"),r.classList.add("show-title"),await l(4200),r.classList.add("show-sub"),await l(1600),n.querySelector(".replay").classList.add("is-offered")}async function Ns(e){const{camera:s,tara:t,spark:o,ui:a}=e;s.set({x:300,y:-1080,zoom:s.zoomToFitWidth(2e3)}),t.setPose("idle").express("neutral"),await l(1200),await s.to({x:1150,y:-560,zoom:s.zoomToFitWidth(2300),duration:7e3,easing:$.inOut}),await s.to({x:1600,y:420,zoom:s.zoomToFitWidth(1900),duration:6500,easing:$.inOut}),await l(900),await s.to({x:c.x,y:c.y+60,zoom:s.zoomToFitWidth(900),duration:5200,easing:$.inOut}),await s.to({x:c.x,y:c.y,zoom:s.zoomToFitWidth(520),duration:4200,easing:$.inOut}),e.root.querySelector(".hero-window").classList.add("is-open"),await l(1500),t.express("curious"),await t.face("right"),await l(700);const i=s.to({...w(0,40),zoom:v*.92,duration:5200,easing:$.inOut});await l(3e3),e.root.querySelector(".portal").classList.add("is-inside"),e.root.querySelector(".hero-window").classList.add("is-passed"),await i,await s.to({...w(-40,90),zoom:v*.96,duration:2200}),await l(600),await k(t.walkTo(x.taraX-360,{speed:210}),s.to({...w(-220,110),zoom:v*.95,duration:3e3})),await l(700),await t.face("right"),await l(500),o.el.classList.add("is-live"),await o.moveTo(360,-160,{duration:1600,easing:$.out}),t.express("curious"),await l(700),await k(o.moveTo(-60,-60,{duration:2600,easing:$.inOut}),s.to({...w(-160,40),zoom:v*1.08,duration:2600})),t.setPose("reach"),await l(520),await o.moveTo(300,-240,{duration:900,easing:$.out}),t.setPose("idle"),t.express("surprised"),s.shake(5),await l(700),t.express("curious"),await k(t.walkTo(x.taraX-60,{speed:190}),s.to({...w(40,-10),zoom:v*1.02,duration:2400})),await l(500),await o.moveTo(150,-170,{duration:1100,easing:$.inOut}),await l(400),o.el.classList.add("is-word"),s.shake(7),t.setPose("surprise"),t.express("surprised"),await l(1400),t.setPose("idle"),t.express("curious"),await l(1600),await s.to({...w(30,10),zoom:v*.9,duration:2600}),a.classList.add("show-title"),await l(4200),a.classList.add("show-sub"),await l(4e3)}const js=[Ns,zs,Cs,Ps,Os,Rs,Fs,Qs,Ws,Gs];async function Hs(e){for(const s of js)await s(e)}const E={width:1600,height:900};class ls{constructor(s){this.el=s,this.x=0,this.y=0,this.scale=1,this.apply()}apply(){this.el.setAttribute("transform",`translate(${this.x} ${this.y}) scale(${this.scale})`)}at(s,t){return this.x=s,this.y=t,this.apply(),this}setScale(s){return this.scale=s,this.apply(),this}setText(s){const t=this.el.querySelector(".sw-text");if(!t)return this;t.textContent=s;const o=Math.max(190,s.length*34+96),a=this.el.querySelector(".sw-plate"),i=this.el.querySelector(".sw-aura");return a&&(a.setAttribute("x",-o/2),a.setAttribute("width",o)),i&&i.setAttribute("rx",o*.78),this}async morphTo(s,{duration:t=900}={}){return this.el.classList.add("is-morphing"),await T({duration:t/2,easing:$.in,onUpdate:()=>{}}),this.setText(s),await T({duration:t/2,easing:$.out,onUpdate:()=>{}}),this.el.classList.remove("is-morphing"),this}scaleTo(s,{duration:t=900,easing:o=$.inOut}={}){const a=this.scale;return T({duration:t,easing:o,onUpdate:i=>{this.scale=a+(s-a)*i,this.apply()}})}moveTo(s,t,{duration:o=1400,easing:a=$.inOut}={}){const i=this.x,r=this.y;return T({duration:o,easing:a,onUpdate:n=>{this.x=i+(s-i)*n,this.y=r+(t-r)*n,this.apply()}})}}function U(e,s){const t=document.createElementNS("http://www.w3.org/2000/svg","g");return s&&t.setAttribute("class",s),t.innerHTML=e,t}function Us(e){e.innerHTML=`
    <div class="stage">
      <svg class="stage-svg" viewBox="0 0 ${E.width} ${E.height}"
      ...
      <div class="ui">
        <svg class="title-svg" viewBox="0 0 ${E.width} ${E.height}"
